...
\familiar{Scorpion}{Scorpions}{scorpion}{5}{
	...
	\ability{Pincers}{
		The \familiarref{scorpion} rolls 2 dice for {\unarmed} {\damagetests} using its pincers.
	}
	
	\ability{Tail Sting}{
		The \familiarref{scorpion} can make attacks with its tail stinger, injecting a deadly venom.
