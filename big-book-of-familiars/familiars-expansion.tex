...
\familiar{Badger}{badger}{15}{
	...
	Badgers are stiped, stocky, burrowing omnivores.
...
\familiar{Dragonfly/Damselfly}{dragonfly}{5}{
	\atttable{\negative 5}{3}{0}{0}{1}{1}{0}{\negative 1}
}{
	\flyspeed{15}
}{
	\skillref[2]{flying}, \skillref[2]{weaponry}
}{
	...
	\ability{Tiny Predator}{
		The dragonfly cannot effectively attack anthing much larger than itself, but rolls 4 dice for unarmed {\damagetests} when picking on something its own size.
	}
