...
\familiar{Bees}{bees}{40}{
	...
	Such a binding is an impressive feat, and a hive familiar can command a witch a lot of respect from those who recognise this.
}{
...
\familiar{Serpent}{serpent}{15}{
	...
	\familiaroption{Constrictor}{10}{
		The serpent gains a \attref{might} score of 1, \skillref[1]{athletics}, and rolls an extra die on Tests to entangle or restrain creatures.
