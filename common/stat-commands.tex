...
\makeatletter
\newcommand\featinner[6][\@nil]{%Arguments: annotation, title, label, XP cost, prerequisites, text.
	\def\featinnerannotation{#1}%
	\ifx\featinnerannotation\@nnil%
		\subsection[#2]{#2 [#4 XP]}%
	\else%
		\subsection[#2]{#2 [#4 XP, {\featinnerannotation}]}%
	\fi%
	\labelname{#2}
	\label{feat:#3}
	\index{#2}
...
%The standard \feat command for feats that belong to a discipline.
\newcommand\feat[6][\@nil]{%Arguments: discipline, title, label, XP cost, prerequisites, text.
	...
	\ifx\featdiscipline\@nnil%
		\featinner{#2}{#3}{#4}{#5}{#6}%
	\else%
		\featinner[\capital{\discref{\featdiscipline}}]{#2}{#3}{#4}{#5}{#6}%
	\fi%
}

%A \genericfeat command for feats that do not belong to a discipline.
\newcommand\genericfeat[6][\@nil]{%Arguments: annotation, title, label, XP cost, prerequisites, text.
	\def\genericfeatannotation{#1}%
	\ifx\genericfeatannotation\@nnil%
		\featinner{#2}{#3}{#4}{#5}{#6}%
	\else%
		\featinner[\capital{\genericfeatannotation}]{#2}{#3}{#4}{#5}{#6}%
	\fi%
}
\makeatother
...
\newcommand\featannotationfamiliar{familiar}
