...
\newcommand\materiallabel[3]{%Arguments: title, plural title, label
	\labelname{#1}%
	\lcaselabel{material:#3}%
	\labelname{#2}%
	\lcaselabel{materials:#3}%
}
...
\newcommand\circlelabel[2]{%Arguments: title, label
	...
	\lcaselabel{circles:#2}%
	\labelname{#1}
	\lcaselabel{circlebare:#2}
}
...
\newcommand\weapontype[4]{%Arguments: title, plural title, label, text
	...
	\lcaselabel{weapon:#3}%
	\labelname{#2}%
	\lcaselabel{weapons:#3}%
	\labelname{#1's}%
	\lcaselabel{weaponpossessive:#3}%
