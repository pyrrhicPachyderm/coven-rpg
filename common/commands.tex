...
\newcommand\disclabel[3]{%Arguments: label, practioner noun, practioner plural
	\chaplabel{#1}%
	\labelname{#2}%
	\label{practioner:#1}%
	\labelname{#3}%
	\label{practioners:#1}%
	\labelname{#2's}%
	\label{practionerpossessive:#1}%
}
\newcommand\discref[1]{\chapnameref{#1}}
\newcommand\practioner[1]{\nameref{practioner:#1}}
\newcommand\practitioners[1]{\nameref{practioners:#1}}
\newcommand\practionerpossessive[1]{\nameref{practionerpossessive:#1}}
