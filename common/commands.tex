...
\newcommand\herbtype[1]{%A herb type with a herb identity
	\nameref{herb:#1}%
}
\newcommand\herbtypeplural[1]{%A herb type with a herb identity
	\nameref{herbs:#1}%
}
\newcommand\herb[2]{%A herb, with identity and type
	#1 (\herbtype{#2})%
}
\newcommand\herbs[2]{%A herb, with identity and type
	#1 (\herbtypeplural{#2})%
}
\newcommand\Herb[2]{%A herb, with identity and type
	\expandafter\MakeUppercase #1 (\herbtype{#2})%
}
\newcommand\Herbs[2]{%A herb, with identity and type
