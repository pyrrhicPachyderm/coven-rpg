...
Familiars suffer \secrefraw{damage}, \secrefraw{shock} and death just like other characters.
...
\familiar{Bees}{bees}{40}{
	...
	\familiarability{Swarm}{
		...
		It is not subject to Shock, or any penalty to its rolls due to damage.
		It has a Resilience of 3, and the swarm is destroyed only when it has taken 15 damage.
		A swarm can be healed only by being replenished from the hive.
	}
	
	\familiarability{Sting}{
		A swarm's unarmed attacks deal 5 dice of damage, and are not affected by the swarm's \attref{might}.
...
\familiar{Cat}{cat}{15}{
	...
	\familiarability{Claws}{
		The cat's unarmed attacks deal 5 dice of damage.
	}
}{}

\familiar{Dog}{dog}{15}{
	\atttable{1}{1}{1}{3}{0}{2}
}{
...
\familiar{Raptor (Eagle/Falcon/Hawk)}{raptor}{25}{
	...
	\familiarability{Beak \& Talons}{
		The raptor's unarmed attacks deal 5 dice of damage.
	}
}{}
