...
Its Shock Threshold is also reduced by 2, in addition to the loss from the reduced \attref{might}.
...
\feat{Stitches}{undead-repair}{10}{
	...
	A successful Test repairs at least enough {\damage} to restore the creature's Shock Threshold to 1, and a high result may repair even more.
}
...
\feat{Medium}{medium}{10}{
	...
	You may enter a mediumship trance by consuming \herb{black henbane, a.k.a.\ stinking nightshade}{2} and meditating for a minute in a dark place.
	...
	The medium's \attref{might} and \attref{grace} are retained, but the creature uses the spirit's other attributes, skills and feats.
	...
	Whenever the spirit is shocked in some fashion, however, such as by {\damage}, a slap to the face, a dunk in icy water or the revelation of a terrible secret, the medium may choose to try and reassert control over her own body.
	...
	Mediums interested in limiting the harm a malevolent spirit can wreak may be interested in \featref{circle-contain}.
}
