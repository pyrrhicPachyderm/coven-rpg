...
Vampires are dangerously allergic to \herb{garlic}{2}.
...
This {\damagetest} sends them into {\shock} as normal; it doesn't cause immediate death, like sunlight.
If they swallow any garlic, however, it continues to burn inside them.
