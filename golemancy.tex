...
A golem lacks the other four attributes (\attref{wit}, \attref{will}, \attref{charm} and \attref{presence}) entirely; it automatically fails Tests that would require them.
...
\feat{Gingerbread Man}{gingerbread-golem}{20}{
	...
	\materials{Flour, sugar, eggs, butter, \herbref[ginger]{3}}
...
\feat{Clay Golem}{clay-golem}{15}{
	...
	It has 10 Resilience and a Shock Threshold of 14.
...
\feat{Golem Intelligence}{golem-intelligence}{20}{
	...
	They gain \attref{wit}, \attref{charm} and \attref{presence} scores of 0, and may make Tests requiring these attributes.
