...
\begin{simpletable}{rX}
	...
	TN & Example Task\\
	\midrule
	9 & Discerning the power of the \chapnameref{necromancy} animating a shambling corpse.\\
	...
	18 & Discerning the power of the \chapnameref{necromancy} that previous animated a no-longer-shambling corpse.\\
...
The idea of \chapnameref{sympathetic-magic} is that one can't affect the imitation of a thing without affecting the thing itself.
