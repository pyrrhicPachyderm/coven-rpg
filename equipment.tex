...
The above guidelines apply to humans, who typically contain about appromimately \SI{5}{\litre} of blood in total.
...
Note that the term ``herb'' is used to encompass any things that are not technically herbs at all, such as fruit, fungi, tree bark and so on.
...
Finding herbs growing in the wild uses \testtype{wit}{botany}.
...
\begin{simpletable}{X[2.4]XXX[1.3]}
	...
	Thrown Rock & +0 & 3 & $5\times\text{\attref{might}}$\\
	Thrown Weapon & +0 & 5 & $5\times\text{\attref{might}}$\\
	Bow & +2 & 5 & 100\\
	\bottomrule
\end{simpletable}
