...
\feat{Taglock Tracing}{identify-taglock}{2}{
	None
}{
	You can touch a taglock and detect who it originates from.
	If you have met the target, you can identify them infallibly.
	
	If you have never met the target, you must make a \testtype{wit}{sympathetic-magic} Test, with higher results giving more information about the target.
