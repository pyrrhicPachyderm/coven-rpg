...
\featref{Sympathetic Communication}{sympathetic-speak}{15}{
	None
}{
	You can send sounds along a {\symlink}, like a string telephone.
	A creature can hear sounds that originate near its {\symbol}.
	The {\symbol} has a very short range of hearing; speaking through it essential requires picking it up and holding it near the mouth.
}
