...
\feat{Sympathetic Sleep}{sympathetic-sleep}{10}{
	...
	However, the target does not recover from \secrefraw{damage} and \secrefraw{exhaustion} as a result of this rest.
}
...
\feat{Sympathetic Warmth}{sympathetic-heat}{10}{
	...
	Counteracting dangerous temperatures---hot enough to cause heat stroke or cold enough to cause hypothermia---requires that the {\symbol} is inversely heated or cooled.
	Temperatures sufficiently extreme to cause \secrefraw{damage}, such as fire or anything that would directly freeze the flesh, are outside the reach of this effect.
}
