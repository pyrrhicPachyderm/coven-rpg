...
\feat{Circle Intrusion}{circle-barrier-break-2}{20}{
	...
	Failing the Test---as well as failing to break or bypass the barrier---violently destroys the knife used to cut the barrier, dealing a \dice{5} {\damagetest} to you as you hold it.
}
...
\feat{Barrier Augmentation}{circle-barrier-augment}{15}{
	...
	However, while the barrier created by one of these circles is active, any rites using the {\augemented} circle must be performed from the \emph{open} side of the barrier circle---from outside a \featref{circle-contain} or from inside a \featref{circle-exclude}.
