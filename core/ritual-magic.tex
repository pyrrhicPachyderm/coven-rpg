...
\section{Feats}
\setfeatdefault{discipline}{ritual-magic}{false}
\unsetfeatdefault{tags}

\feat{Delayed Ritual}{ritual-magic-delay}{10}{
	\Anyfeatdiscipline{ritual-magic}
}{
...
\feat{Combined Concealment}{ritual-hide-combine}{10}{
	...
	This does not affect the size of the \materialref{ritual-circle} you can use, only the design.
}
...
\feat{Drastic Scaling}{ritual-size-more}{15}{
	...
	Cancelling this effect requires that the opposite ritual is also performed with this modification; it has no effect if performed normally.
}
