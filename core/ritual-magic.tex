...
\feat{Immediate Transposition}{ritual-teleport-speed-2}{15}{
	...
	Furthermore, you may pass through and remove the rod from the ground again as part of the same {\action}.
	You may even \actionref{ready} to remove the rod from the ground, still as a part of the same {\action}.
}

\feat{Loose Transposition}{ritual-teleport-no-circle}{20}{
	\skillref[1]{ritual-magic},
	\featref{ritual-teleport}
}{
	The \featref{ritual-teleport} needs solid structures at both ends to anchor the connection.
	One \materialrefplural{standing-stone} doesn't have the mass that several do, but it's still fairly significant.
	
	You may use a \materialref{standing-stone} instead of a \materialref{stone-circle} for one end of the \featref{ritual-teleport}.
	The other end must still be a \materialref{stone-circle}.
}
