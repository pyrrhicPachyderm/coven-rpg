...
\feat{Circle Bypass}{circle-barrier-bypass}{15}{
	\skillref[1]{ritual-magic},
	\featref{circle-barrier-break}
}{
	When you use \featref{circle-barrier-break}, you can hold your circles' barriers open temporarily, instead of breaking them entirely.
	If you do so barrier disappears for only as long as you hold the knife in it---you may retract it later in the same {\turn}, or hold it open for several minutes.
	After you remove the knife, the barrier comes back up, as long as it has remaining duration.
	You must remain holding the knife; the effect ends if you let it go.
}
