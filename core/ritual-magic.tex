...
\feat{Circle Bypass}{circle-barrier-bypass}{10}{
	...
	Instead of breaking your circles' barriers, you can just flicker them down temporarily.
	When you use \featref{circle-barrier-break}, you may drop the barrier only temporarily.
	It automatically comes back up after 1 {\round}.
}
