...
However, some \materialrefplural{ritual-circle} are simple an adaptable enough that they can be used to {\augment} an existing circle.
...
\feat{Barrier Augmentation}{circle-barrier-augment}{15}{
	...
	However, the \featref{circle-contain}, \featref{circle-exclude} and \featref{circle-contain-exclude} are all incompatible, and no two can ever be scribed in the same place.
}
...
\feat{Rite of Invisibility}{ritual-hide}{10}{
	...
	You can still yourself and your equipment.
}
