...
If she takes the \actionref{dash} {\action}, she may move a total number of metres equal to twice her \statref{speed}.
...
In the case of an attack by one character upon another, the number of dice are determined by the weapon used and the flat bonus by the wielder's \attref{might}.
...
A {\dayofrest} reduces {\exhaustion} by another level.
