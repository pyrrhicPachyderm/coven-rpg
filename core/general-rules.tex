...
Some of the {\actions} available to a character are given in the \secref{combat-actions} section, but the GM is free adjudicate anything the characters try as one or more {\actions}.
