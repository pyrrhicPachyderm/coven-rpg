...
When two characters---be it two player characters or a player and a non-player character---act in direct opposition to one another, the GM may request an opposed Test.
...
Opposed Tests need not use the same attribute and skill for both characters.
...
This is not possible in the event of an opposed Test, so the GM may grant a bonus or penalty to a character at an advantage or disadvantage.
...
Bonuses and penalties may be assigned, as for \seclink{opposed Tests}{opposed-tests}.
