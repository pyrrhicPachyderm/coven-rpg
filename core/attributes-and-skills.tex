...
\simpletable{XXX}{
	...
	\capital{\skillref{perception}} & \capital{\skillref{sigilry}}\\
...
\skill[sigilry]{Sigilry}{sigilry}

Used to scribe, empower, and identify magical {\sigils}.
Much as \skillref{ritual-magic} works with \materialrefplural{ritual-circle}, \skillref{sigilry} governs familiarity with {\sigils} and {\sigilmarks}, and the ability to scribe them quickly and accurately.
