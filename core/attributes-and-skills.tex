...
Note that you don't have to draw attention if you don't want to; a high \attref{presence} doesn't make it any harder to hide.
...
\simpletable{XXX}{
	...
	\capital{\skillref{perception}} & \capital{\skillref{sigil-magic}}\\
	\capital{\skillref{persuasion}} & \capital{\skillref{sympathetic-magic}}\\
	\capital{\skillref{socialising}} & \capital{\skillref{willing}}\\
...
\skill[sigil-magic]{Sigil Magic}{sigil-magic}

Used to scribe, empower, and identify magical {\sigils}.
Much as \skillref{ritual-magic} works with \materialrefplural{ritual-circle}, \skillref{sigil-magic} governs familiarity with {\sigils} and {\sigilmarks}, and the ability to scribe them quickly and accurately.
