...
The following table lists all the skills available to a witch, catagorised by type.
The details of each skill, and examples of their use, are provided in the following sections.

\begin{simpletable}{XXX}
	\toprule
	\seclink{General}{general-skills} & \seclink{Discipline}{discipline-skills} & \seclink{Speciality}{speciality-skills}\\
	\midrule
