...
An {\interface} only lasts while your minds remain touching in the {\mentalrealm}.
...
\feat{Shape of a Mind}{projection-read-mind}{10}{
	...
	When you touch a creature's mind in the {\mentalrealm}, you can feel the creature's emotions.
...
\feat{Mind Meld}{projection-merge}{15}{
	...
	When you establish a connection using \featref{projection-speak}, you may strengthen it further still, merging two minds together.
	Note that the target may accept \featref{projection-speak} without accepting this deeper level of connection, and may still end the connection at any time.
	This connection grants you some degree of control over the target's body, if the target is currently inhabiting it.
	Enough control to help out in what they're doing, although they always retain the final say in any movements and actions.
