...
Feats from outside the \discred{projection} discipline cannot be used in the {\mentalrealm}, unless specified.
...
\feat{One Eye Outside}{projection-mental-realm-sense}{15}{
	...
	This only senses the area around the body you are currently inhabiting, at the present time, regardless of any \discref{divination} you are using.
}
