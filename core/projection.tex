...
\feat{Borrow Sight}{projection-read-sight}{15}{
	...
	While you have a {\subtleinterface} with a creature's mind, you can see what it sees.
...
\feat{Borrow Hearing}{projection-read-hearing}{15}{
	...
	While you have a {\subtleinterface} with a creature's mind, you can hear what it hears.
}
...
\feat{Borrow Senses}{projection-read-senses}{10}{
	...
	While you have a {\subtleinterface} with a creature's mind, you gain input from all its senses: sight, hearing, smell, taste and touch, as well as the senses of temperature, balance, pain, and so on.
...
\feat{Speak to the Mind}{projection-speak-unwilling}{15}{
	...
	You may want \featref{projection-read-hearing} or \featref{projection-read-mind-2} for that.
}
