...
\capital{\minds} in the same room can be sensed automatically, while a \testtype{heed}{projection} might extend the sense to fill a house or more.
...
A {\possessed} creature uses the body's \attref{might} and \attref{grace}, but the {\possessing} {\mindpossessive} other attributes, skills, and feats.
...
She makes a \testtype{will}{projection} {\test}, {\opposed} by the {\possessing} {\mindpossessive} \testtype{will}{projection} {\test}.
...
\section{Feats}
\setfeatdefault{discipline}{projection}{false}
...
\feat{Mindjack}{projection-start-other-2}{20}{
	...
	Whether you succeed or fail, the creature is awakened, unless it is unable to be roused in any fashion due to poisoning or the like.
	...
	In this case, however, a {\mind} that subsequently {\possesses} the body might find itself affected by whatever poison rendered the creature unconscious in the first place.
}
...
\feat{Assisted Possession}{projection-possession-other}{15}{
	\skillref[1]{projection},
	\featref{projection-possession}
}{
	You can help another {\mind} slip into an unoccupied body.
	While you have an {\overtinterface} with another {\mind} which is loose in the {\mentalrealm}, and are adjacent to an unoccupied body, you can allow the other {\mind} to {\possess} the body.
...
\feat{Sense Interface}{projection-interface-sense}{10}{
	...
	As well as just sensing when it has happened, you get all the information you would get if it was an {\overtinterface}---the other {\mindpossessive} identity, which powers they are using through the interface, and so on.
...
\feat{Sleep in Absentia}{projection-sleep}{10}{
	...
	You have trained your body to rest in your {\mindpossessive} absence.
...
\feat{Borrow Sight}{projection-read-sight}{10}{
	...
	That you can read a person's thoughts by staring into their eyes.
...
\feat{Dream Shaping}{projection-dreams}{10}{
	...
	Such sleep does not help it recover from {\damage} or {\exhaustion}, although they may still recover 1 point of {\damage} and 1 level of {\exhaustion} from a {\dayofrest}.
...
\feat{Mind Meld}{projection-merge}{15}{
	...
	While your {\minds} are merged, you may make any {\tests} using the attributes or skills from either participant in the {\mind} meld.
	...
	Furthermore, you cannot work magic through a body using a {\mind} meld: you cannot use any feats other than those that you can normally use within in the {\mentalrealm}.
}
...
\feat{Magic Meld}{projection-merge-2}{15}{
	...
	One of you can even maintain {\symlinks} created using the other's feats.
}
...
\feat{Mental Circle Intrusion}{projection-barrier-bypass-2}{15}{
	...
	However, unlike \featref{circle-barrier-break-2}, it does not require a {\test}.
}
