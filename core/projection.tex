...
\feat{Hide in Absentia}{projection-remain-hide}{10}{
	...
	Remember, however, that if somone can find your body in the physical realm, it becomes far easier to find it in the {\mentalrealm}.
}
...
\feat{Shape Senses}{projection-change-senses}{20}{
	...
	While you with a {\subtleinterface} with a mind that currently resides within a body, you can alter what it senses.
	...
	For now, your influence is subtle; you cannot fabricate \emph{everything} they sense, like you can while they are awake.
	...
	You cannot form an entirely new object, unless it is very simple, and you cannot make somone look like someone else entirely.
