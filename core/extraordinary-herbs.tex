...
\creature{Stygian Nightshade}{Stygian Nightshades}{stygian-nightshade}{
	...
	\ability{Stygian Darkness}{
		The \creatureref{stygian-nightshade} dwells within a region of inpenetrable darkness, about a dozen metres in diameter.
	...
	\ability{Writhing \& Rending}{
		...
		\weaponref{unarmed}, it has \positive{4} accuracy and rolls 5 dice for {\damagetests}, addings its \attref{might} as usual.
	}
}
