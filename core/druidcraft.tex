...
As an exception, an \herbtypeplural{5} that is conscious, or intelligent---one with a score in any non-physical attribute---is \emph{never} considered {\wild}.
...
\feat{Wild Beastmaster}{animal-companion-wild-2}{15}{
	...
	You may make \emph{every} \featref{animal-companion} a \featref{animal-companion-wild}, if you wish.
}
...
\feat{Forestwalker}{plant-movement}{10}{
	...
	You have an agreement of sorts with the plants of the world.
	They won't hurt you if you don't hurt them.
	
	You are unaffected by {\difficultterrain} or other impediment of movement caused by plants.
	This doesn't go quite so far as to let you walk through solid trees, but you can run through a bramble bush just fine.
	Furthermore, their natural defenses, such as a bramble's thorns or a nettle's sting, don't affect you.
	...
	Lastly, this does not affect \herbtypeplural{5}; they have a mind of their own.
}
...
\feat{Treespeaker}{plant-speak}{10}{
	...
	You may listen to the plants around, reading the visible and audible signs they give.
...
\feat{Bloom}{plant-grow}{10}{
	\skillref[1]{botany}
}{
	Touching a plant, you can stimulate a part of it to grow quickly.
	...
	It takes about a minute to grow a part like this, and it takes a lot out of the plant.
	You cannot use this same effect on the same plant until a day afterwards, and nor can anyone else.
}
...
\feat{A Stand of Trees}{tree-standing-stone}{15}{
	...
	You may treat any tree taller than a man as a \materialref{standing-stone}, without a Test.
...
\feat{Familiar Attributes}{familiar-attributes}{15}{
	\noprereq
}{
