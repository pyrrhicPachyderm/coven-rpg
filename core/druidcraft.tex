...
\feat{Taglock Transformation}{animal-transform-3}{25}{
	...
	When you use \featref{animal-transform}, you can touch a \materialref{taglock} from an animal, instead of the animal itself.
	You cannot use both this \emph{and} \featref{animal-transform-2}: you must see the animal, or touch the \materialref{taglock}.
}
