...
As such, \practitioners{druidcraft} often strip down before {\transforming}, or wear clothing loose enough to climb out of after they {\transform}.
...
The target is still affected by any {\damage}, and if this reduces its new \statref{shock-threshold} to 0 or below, it dies.
...
\feat{Walkies}{animal-speed}{10}{
	...
	This applies to walking, swimming, flying, or any other method the animal possesses.
	This benefit applies automatically to an \featref{animal-companion}, but also applies to other animals that the witch has played a major part in training.
}

\feat{Run Like the Wind}{animal-speed-2}{10}{
	\skillref[2]{animals},
	\featref{animal-speed}
}{
	Your beasts are champion runners, flyers, or swimmers, capable of incredible turns of speed.
...
\feat{Beast Shape}{animal-transform}{15}{
	...
	You can {\transform} into the shape of an animal you touch.
	This requires 5 minutes, and you must remain in contact with the animal for the duration.
	You take on a generic form corresponding to that animal---for example, if you touch a bear, you take on a generic bear form.
	The {\transformation} lasts up to an hour, then reverts over the course of 5 minutes.
	You can revert to your original form earlier, also requiring 5 minutes.
...
\feat{Taglock Transformation}{animal-transform-3}{25}{
	\skillref[3]{animals},
	\featref{animal-transform-2},
	\featref{animal-transform-duration-2}
}{
	Taking a small piece of an animal, you can use it to inform your {\transformations}.
	When you use \featref{animal-transform}, you can use a \materialref{taglock} from an animal, instead of the animal itself.
	It is not enough to see the \materialref{taglock}---you must touch it.
}

\feat{Rapid Transformation}{animal-transform-speed}{15}{
	\skillref[2]{animals},
	\featref{animal-transform}
}{
	You can use \featref{animal-transform}---and revert from it---in just one {\action}.
}
...
\feat{Imitative Transformation}{animal-transform-imitate}{15}{
	...
	When you use \featref{animal-transform}, you may imitate the specific beast you are {\transforming} into, rather than taking a generic form.
}
...
\feat{Transformed Tongue}{animal-transform-language}{20}{
	...
	Even while {\transformed}---by \featref{animal-transform} or some other effect---you may speak like a human, regardless of your anatomy.
	You still need to move your mouth, or something similar, and some of your animal nature is audible in your voice---you will require a {\test} to sound properly human.
	But you're easily understandable, and just as loud as normal.
}
...
\feat{Familiar Witchspeak}{familiar-language-2}{5}{
	...
	However, it can also communicate with anyone who has somehow had a familiar, but is not a witch.
}
