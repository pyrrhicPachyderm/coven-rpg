...
\feat{Calling Order}{animal-call-language}{10}{
	...
	Furthermore, you can only use this on animals that yoou can communicate with using \featref{animal-language}---you need \featref{animal-language-2} to use this on {\wild} animals.
}

\feat{Irresistable Call}{animal-call-2}{15}{
	\skillref[3]{animals},
	\featref{animal-call}
}{
	...
	This cannot be used in conjuntion with \featref{animal-call-language}---it is always, and only, a call.
