\chapter{Golemancy}
\disclabel{golemancy}{Golemancer}{Golemancers}
...
A novice \practitioner{golemancy} has only enough animating force to maintain one golem at a time.
...
\feat{Golem Reanimation}{golem-reanimate}{15}{
	...
	You can animate a golem's body at any time, even separately from its creation.
...
\feat{Horse Golem}{golem-horse}{15}{
	...
	Therefore, the horse variety of a \featref{large-golem} can be ridden by a human, as long as it is made of a stronger material than gingerbread.
...
\feat{Remote Access}{change-golem-instructions-projection}{15}{
	\skillref[1]{golemancy},
	\featref{projection-golemancy},
	\featref{change-golem-instructions}
}{
	You can do more than just find your golems in the mental realm: you can alter them.
	You can reprogram a golem while touching it in the {\mentalrealm}, instead of physically.
	This still takes however long it would normally take you.
}
