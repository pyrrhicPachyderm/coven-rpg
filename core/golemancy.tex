...
A golem whose \statref{st} is met or exceeded by a {\damagetest} is immediately destroyed, instead of going into {\shock}.
...
\feat{Dwarf Golem}{medium-golem}{20}{
	...
	They use 2 dice for \weaponref{unarmed} {\damagetests}.
...
\feat{Batch Baking}{golem-batch-gingerbread}{20}{
	...
	Golems beyond these four always use their usual allotment of animating force.
}
