...
\feat{Rapid Programming}{golem-change-instructions-fast}{15}{
	...
	You may use \featref{golem-change-intructions} as an {\action}, though you still have to touch the golem.
	If you have \featref{golem-change-instructions-familiar}, you familiar also only requires an {\action}.
	Note that this allows you to imbue a minute's worth of instructions in one {\action}, so it is useful even if you have \featref{golem-understand-language}.
}
...
\feat{Rapid Golemancy}{golem-animate-fast}{20}{
	...
	This applies when using \featref{golem-reanimation}, but also when crafting the golem.
