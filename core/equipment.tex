...
The wielder's \attref{might} is added to the {\damagetest} for melee or thrown weapons, but not for \weaponrefplural{bow} or \weaponref{blowguns}.
The bonus to the {\damagetest} for \weaponrefplural{bow} is determined by their draw weight, as explained in their section.
\weaponref{blowguns} receive no bonus to the {\damagetest} at all.
