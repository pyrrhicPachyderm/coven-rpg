...
The wielder's \attref{might} is added to the damage roll for melee or thrown weapons, but not for \weaponrefplural{bow} or \weaponref{blowguns}.
The bonus to the damage roll for \weaponrefplural{bow} is determined by their draw weight, as explained in their section.
\weaponref{blowguns} receive no bonus to the damage roll at all.
