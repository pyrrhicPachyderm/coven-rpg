...
Rarer herbs are harder to cultivate, however, requiring a witch---or a familiar---skilled in \skillref{botany}.
\herbtypeplural{5}, in particular, are liable to attack or flee from a witch who doesn't care for them properly.

The following table gives the \skillref{botany} skill required to cultivate a herb.
...
Many witches keep a garden, for growing herbs, or keeping animals.
...
A witch's garden does more than simply provide a little flavour to a character; it provides the herbs and other components she needs to work her magic.
...
\herbtype{1} require no effort at all; these weeds will spring up on any patch of ground, uninvited.
Otherwise, it takes about 4 hours each week for \herbtype{2}, 8 hours for \herbtype{3}, 12 hours for \herbtype{4}, and 16 hours for \herbtype{5}.
...
Typically about an hour per day, per type of animal, though this may be reduced by a high \skillref{animals} skill.
