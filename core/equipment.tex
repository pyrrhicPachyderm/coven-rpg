...
There are also a couple of essential items which every witch is assumed to begin with, but which may be detailed and fleshed out as the player wishes: namely, a trained {\broomstick} and a pointed {\hat}.
...
\begin{simpletable}{llX}
	...
	\midrule
	\herbtypebare{1} & - & Dock, Nettle, Clover\\
	\herbtypebare{2} & - & Lavender, Rosemary, Elderberry\\
	\herbtypebare{3} & 1 & Tomato\\
	\herbtypebare{4} & 2 & Truffle\\
	\herbtypebare{5} & 3 & Mandrake, Triffid\\
	%TODO: Expand
	\bottomrule
\end{simpletable}
...
\notedtable{XllX[1.5]}{
	...
	\midrule
	\weaponref{unarmed} & +2 & \dice{2}\tnote{*} & Melee\\
	...
	\weaponref{bow} & +2 & \dice{5}\tnote{\dag} & $25 + 25 \times {}$ $\text{Draw Weight}$\\
	\weaponref{blowgun} & +2 & \dice{3}\tnote{\ddag} & 15\\
	\bottomrule
}{
