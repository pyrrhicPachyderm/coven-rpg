...
\feat{Raise Wraith}{animate-wraith}{20}{
	...
	Using the victim of a violent death, and a sprig of \creatureref{stygian-ngithshade} placed in its mouth, you can raise a powerful and violent variety of \undeadref{shade}: a \undeadref{wraith}.
...
\feat{Assert Control}{undead-control-2}{15}{
	...
	However, you cannot use this against undead that cannot normally be subject a \practitionerpossessive{necromancer} control, such as \undeadrefplural{souled}.
...
\feat{Steal Control}{undead-control-3}{15}{
	...
	You can use the \featref{undead-control} ritual on an undead controlled by another \pracititioner{necromancy}, breaking their hold and bringing it under your control.
