...
A \undeadref{zombie} is the simplest reanimation possible; the corpse, fully clothed in its own flesh, it simply stood up and walked around as it is.
...
It loses 4 \statref{speed} in addition to the loss from the reduced \attref{grace}.
...
Reanimating a corpse as a \undeadref{zombie} requires that it is unrotted.
...
Even an \featref{reanimate-familiar} is not immune to this: it goes insane with hunger after a week, and does not return to sanity until it has fed again.
%It is impossible to ration a \undeadrefpossessive{ghoul} food; once it begins consuming flesh, it will continue until no more is available.
%Thankfully, this only includes dead flesh; a \undeadref{ghoul} under the control of a necromancer can at least be prevented from killing.
...
It is not controlled by the necromancer who reanimated it.
...
\feat{Raise Ghoul}{animate-ghoul}{20}{
	...
	The reanimation ritual takes five minutes, and must be performed in the dark.
	At the conclusion of the ritual, the newly-arisen \undeadref{ghoul} must immediately be fed a complete corpse---of the same kind of animal as the ghoul---or it does not fall under the necromancer's control.
}
...
\feat{Sever Soul}{undead-human}{20}{
	...
	Reanimating a creature that once possessed a soul has previously proved impossible, due to interference from the residual link.
	You've learned to sever these links, and hence resurrect these creatures.
	
	You may resurrect a human, or an animal that once a familiar, using any of the reanimation rituals provided by
	...
	Resurrecting a human requires a \circleref{medium}, as per \featref{undead-larger}.
}
...
\feat{Undead Familiar}{reanimate-familiar}{10}{
	...
	You may use any of the reanimation rituals provided by
	\featref{animate-zombie}, \featref{animate-skeleton} or \featref{animate-ghoul},
	provided you know them.
...
\feat{Phylactery}{phylactery}{10}{
	...
	Examples include a resurrection pact with a trustworthy friend who knows this same procedure, having your familiar do it (\featref{phylactery-familiar}), or ensuring you can stick around to do it yourself ({\possession}). %TODO: Couple featrefs here.
	...
	\materials{The object to become a {\phylactery}, a drop of your own blood, \herb[deadly nightshade]{belladonna}{2}, a \circleref{medium}}
	
	Secondly, you have learned to use a {\phylactery} in a reanimation ritual.
	This must be the {\phylactery} containing the soul of the person whose body is being resurrected, but you may do this with anybody's {\phylactery}, not just your own.
	
	You may use any of the reanimation rituals provided by
	\featref{animate-zombie}, \featref{animate-skeleton} or \featref{animate-ghoul},
	provided you know them.
	The {\phylactery} takes the place of the candle in the ritual, which typical requires a \circleref{medium}, as per \featref{undead-larger}.
	The person is reanimated as a kind of \undeadref{souled} appropriate to the reanimation ritual used.
}

\feat{Familiar Resurrection}{phlactery-familiar}{10}{
	\skillref[1]{necromancy},
	\featref{phylactery}
}{
	Resurrecting yourself is hard, what with being dead and all.
	...
	It is only the link between the soul in your {\phylactery} and the sliver of the same soul in your familiar that affords it the magical intuition to do this, so it can only perform the ritual in order to resurrect \emph{you}.
}
