...
The \undeadref{draugr} is aware of this limitation, and will avoid moisture when not under a \practionerpossessive{necromancer} direct control.
...
\emph{Continuous} attention using \featref{willing-water-vapour} also suffices.
...
\feat{Raise Draugr}{animate-draugr}{20}{
	...
	\materials{An animal corpse {\embalmed} by dessication (drying out), a \circleref{small}, a lit candle which the ritual extinguishes}
