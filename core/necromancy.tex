...
\feat{Offensive Deanimation}{deanimate-2}{10}{
	\featref{deanimate}
}{
	You have learned to draw the animation out of an undead whether you control it or not.
...
\feat{Maintain Control}{undead-control}{10}{
	...
	When you have finished casting the ritual, the undead enters suspended animation; it simply remains the \featref{ritual-circle}, unmoving.
	...
	If you have the ability to control multiple undead, you may affect multiple undead with one \featref{ritual-circle} and one invocation of the ritual.
	The size of the \featref{ritual-circle} required is determined by the size of the largest undead in the group.
...
\feat{Assert Control}{undead-control-2}{10}{
	...
	You have discovered a way to reassert control over an undead, if you lose it.
	Or even to take control of other uncontrolled undead you run into.
	It requires somehow keeping them in a \materialref{ritual-circle} for a while, but it's less damaging than killing and reanimating them.
	
	\materials{An uncontrolled undead, a \materialref{ritual-circle} of the same size required to initially animate the undead, a lit candle which the ritual extinguishes, an unlit candle which the ritual lights}
	
	The ritual takes five minutes, and the undead must remain within the \materialref{ritual-circle} for the duration.
	At the completion of the ritual, it comes under your control.
	However, you cannot use this against undead that cannot normally be subject to a \practitionerpossessive{necromancy} control, such as \undeadrefplural{souled}.
...
\feat{Precision Control}{control-deanimate-small}{10}{
	...
	You can use a \circleref{small} for the \featref{deanimate}, \featref{undead-control}, or \featref{undead-control-2} rituals---assuming you have the feat to perform the ritual at all---regardless of the size of circle you would require to animate the creature in the first place.
...
\feat{Rapid Control}{control-deanimate-fast}{20}{
	...
	You can perform the \featref{deanimate}, \featref{undead-control}, or \featref{undead-control-2} rituals in just one {\action}.
}
