...
A corpse reanimated as a zombie loses 2 points from all attributes except \attref{might} and \attref{will}.
...
A corpse reanimated as a zombie is not healed of any {\damage}.
...
A corpse reanimated as a skeleton loses 2 points from all attributes except \attref{grace} and \attref{will}.
...
\feat{Reanimate Familiar}{reanimate-familiar}{10}{
	...
	Your familiar is subject to the usual modifications to its statistics, as appropriate to the kind of reanimation.
	However, its \attref{might} and \attref{grace} are the only attributes subject to change; the six are always unchanged.
...
\feat{Medium}{medium}{10}{
	...
	While the medium is in a trance, she is vulnerable to possession by any nearby souls of the dead.
	These can include the souls of those who have died nearby, family members and friends of the medium or other nearby people, those who took some special interest in the medium (such as her mortal enemies), or sometimes even randomly passing souls.
	A soul is aware of the medium's identity, and must choose to possess her body.
	
	The possessing soul gains full control of the medium's body.
	The medium's \attref{might} and \attref{grace} are retained, but the creature uses the soul's other attributes, skills and feats.
	...
	The possession lasts indefinitely, until the soul reliquishes it, making possession by a non-benign soul a very risky prospect.
	Whenever the soul is shocked in some fashion, however, such as by {\damage}, a slap to the face, a dunk in icy water or the revelation of a terrible secret, the medium may choose to try and reassert control over her own body.
	She makes a \attref{will} Test, opposed by the possessing soul's \attref{will} Test.
	If the medium succeeds, she regains control over her own body and ends the possession.
	
	If the medium hopes to gain information from the possessing soul, she is advised to have an assistant to ask the soul questions, or at least to leave it a piece of paper with some questions and a quill to record its answers.
