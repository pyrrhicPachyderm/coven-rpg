...
\feat{Undead Familiar}{reanimate-familiar}{10}{
	...
	Reanimating a familiar in this way does not prevent recovering it through the usual repetition of the binding ritual later (see the \secref{familiar-injury-death} section), although the normal XP cost must still be paid each time that method used.
}
