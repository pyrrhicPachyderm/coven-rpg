...
\capital{\embalming} a corpse typically takes a few hours, and requires a \testtypespeciality{ken}{crafting}{Embalming} {\test}.
Failure means that the corpse, or some part of it, won't be preserved, or at least won't last as long as it could.
...
\feat{Animal Ghosts}{ghost-creation-weak-soul}{10}{
	...
	A {\weaksoul} is harder to bind to this realm; it hardly has enough substance to form a {\ghost}.
