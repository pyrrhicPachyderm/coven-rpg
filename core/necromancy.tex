...
\feat{Self-Sacrifice}{phylactery-self}{10}{
	...
	Examples include a resurrection pact with a trustworthy friend who has the \featref{reanimate-souled} feat, having your familiar resurrect you (\featref{reanimate-souled-familiar}), or ensuring you can stick around to do it yourself (\featref{projection-phylactery}).
}
...
\feat{Imbue Soul}{reanimate-souled}{10}{
	...
	As such, this feat is only normally useful in conjuction with \featref{phylactery-self}. %TODO: List other useful feats.
}
...
\feat{Bound by Death}{ghost-creation-death}{10}{
	\featref{ghost-detect}
}{
...
\feat{Animal Ghosts}{ghost-creation-weak-soul}{10}{
	...
	You can create {\ghosts} of {\weaksouled} creatures using \featref{ghost-creation-death}---or using \featref{ghost-creation-point}, if you have it.
}
