...
\feat{Ride Astride}{broom-astride}{15}{
	...
	Doing so, you can safely go up to \SI{150}{\kilo\metre\per\hour}---about 450 metres per round.
...
\feat{Tailwind}{broom-speed}{10}{
	...
	You may safely travel up to \SI{1200}{\kilo\metre\per\hour}---over 3 kilometres per round.
}
