...
\feat{Jumpstart}{broom-start-2}{20}{
	...
	This still does not allow you to climb vertically, so you have to level off quickly to avoid stalling immediately.
}
...
\feat{Autopilot}{broom-sleep}{15}{
	...
	\featref{projection-remain-dodge} allows you to travel at your full speed, and leaves you just as stable on your broom as when you are conscious.
	\featref{projection-remain-navigate} allows you to steer along a pre-defined path, and even to land and continue on foot.
}
...
\feat{Distant Summons}{broom-summons-3}{25}{
	\skillref[2]{flying},
	...
	It can push open cupboard doors and the like, but obviously can't operate doorhandles.
...
\feat{Reclaim Broom}{broom-summon-ridden}{10}{
	...
	It still has to be \emph{your} broom, so this is only normally useful if another witch has stolen it.
}
