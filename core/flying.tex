...
\feat{Ride Astride}{broom-astride}{15}{
	...
	As usual, you can go twice as fast with a Test.
...
\feat{Tailwind}{broom-speed}{10}{
	...
	You may safely fly at up to \SI{1200}{\kilo\metre\per\hour}---over 3 kilometres per round.
	Exceeding this speed---the speed of sound---is not merely unsafe; it is almost invariably lethal.
	Shockwaves simply tear you and your broom apart.
}
...
\feat{Mach Speed}{broom-speed-2}{15}{
	...
	\skillref[2]{willing},
	\featref{broom-speed},
	\featref{willing-wind-others}
}{
	You can break the sound barrier, using \discref{willing} to drive the shockwave before you.
	You may safely fly at up to \SI{3600}{\kilo\metre\per\hour}---about 10 kilometres per round.
	You may even briefly exceed this speed with a Test, using your choice of \skillref{flying} or \skillref{willing}, but the consequences of failure are deadly.
...
\feat{Bristlebrake Turn}{broom-turning}{15}{
	...
	Turning more than \SI{90}{\degree} by this method requires a difficult Test, and stalls the broom on a failure.
}
...
\feat{Summon Cargo}{broom-summon-weight}{20}{
	...
	A passenger with \featref{broom-speed} can stay on at any speed your broom can acheive, however.
}
