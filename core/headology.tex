...
\discref{headology} is really no magic at all.
...
This should often be a negative modifier without a good argument or some evidence, while presenting a solid piece of evidence can give a positive modifer.
...
Even if they try.
This means that it is impoosible to \emph{willingly} be the subject of \discref{headology}.
...
Other \practitioners{headology} tend to be even quicker on the uptake, and are likely to catch on the very fisrt time they see a trick, if the witch using it on them isn't careful.
