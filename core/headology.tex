...
\section{Feats}
\setfeatdefault{discipline}{headology}{false}
...
\feat{Blessing}{blessing-2}{20}{
	...
	You can grant the benefit of \featref{blessing} simply by convincing people they are under some magical boon that makes them more likely to succeed.
}
...
\feat{Elsewhere}{headology-stealth-2}{15}{
	...
	This only holds up as long as you aren't too intrusive.
	...
	Furthermore, this feat does allow you to go unnoticed in a crowd, as long as the person watching has good reason to believe you won't be there.
}
