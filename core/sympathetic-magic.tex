...
Furthermore, resistance can dislodge even an established {\symlink}.
A target who is aware they are bonded by a {\symlink}, and does not wish to be, automatically breaks the link after about a minute.
This applies even if they previously accepted the link, but now wish to shake it off.
...
\feat{Stable Sympathy}{symlink-stable}{20}{
	...
	By using an \materialref{effigy} in the likeness of the target as the {\symbol}, the {\symlink} will remain in place indefinitely, even when resisted.
...
\feat{Sympathetic Jerk}{sympathetic-puppet}{15}{
	...
	An expert practioner of \discref{sympathetic-magic} can make their target dance on the puppet strings of their {\symlink}.
...
\feat{Sympathetic Destruction}{sympathetic-damage}{20}{
	...
	Roll a {\damagetest} against the target, using your \skillref{sympathetic-magic} skill, with no applicable attribute.
