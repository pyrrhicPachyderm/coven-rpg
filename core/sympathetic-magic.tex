...
\feat{Link Reversal}{symlink-reverse}{10}{
	...
	With the standard variety of {\symlink}, the reversed link is targetting an object, and many effects will be useless.
}
...
\feat{Sympathetic Surgery}{sympathetic-healing}{10}{
	...
	Any malpractice is treated as \featref{sympathetic-stabbing}, which {\stresses} the {\symlink}.
