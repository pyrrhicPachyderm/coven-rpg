...
The simplest method for establishing a {\symlink} simply requires touching the {\symbol} to the target.
...
She must touch the {\symbol} to the target, using an {\action}, to establish the {\symlink}.
