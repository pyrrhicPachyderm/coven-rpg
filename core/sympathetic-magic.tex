...
In this case, make a \testtype{wit}{sympathetic-magic} Test {\opposed} by the target's \testtype{will}{sympathetic-magic}.
If the target wins the Test, the {\symlink} is broken.
Actions that {\stress} a link will say so in their relevant feats.

\section{Feats}

\feat{Stability in Imitation}{symlink-stable}{10}{
...
\feat{Taglock Binding}{symlink-taglock}{20}{
	...
	{\symlinks} fastened in this way are weaker.
