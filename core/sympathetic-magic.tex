...
\feat{Sympathetic Narcolepsy}{sympathetic-sleep-cause}{15}{
	...
	\featref{sympathic-sleep} lets a {\symbol} sleep instead of the target.
	You've reversed this, and may instead let the {\symbol} send the target to sleep.
	
	If you tuck a {\symbol} in, as you would for \featref{sympathic-sleep}, then you may cause it to bring on tiredness in the target.
