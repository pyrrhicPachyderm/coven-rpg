...
\feat{Hindsight}{hindsight}{10}{
	...
	Speech is hard to interpret in reverse, requiring a \attref{wit} {\test} for anything but the most simplest phrases.
}
...
\feat{Tarot}{foresight-chance}{25}{
	...
	If you succeed on the {\test}, and the event you specified occurs within the time \featref{foresight} would normally allow you to view, then you receive a {\vision} of the event, of the usual length.
	If you fail the {\test}, or if the event would not occur where you could sense it within the time you can view, then you receive a {\vision} of a random point within the time you searched.
...
\feat{Omens of Self}{foresight-aim-self}{10}{
	\skillref[1]{divination},
	...
	Rather than using omens to search the future of the place you currently stand, you can use them to search your own future.
	...
	Instead of searching for an event in the place your scrying sensor is currently positioned, this searches for an event that occurs wherever \emph{you} are in the future.
	...
	For example, if you used this with \featref{foresight-entrails}, it would focus on the most violent even that occurs to you within the time period you search.
	If you use this with \featref{foresight-chance}, and fail, it still focuses on your position at the random time you see.
}

\feat{Omen Tracing}{foresight-aim-taglock}{15}{
	\skillref[2]{divination},
	\featref{foresight-aim-self},
	\featref{divination-taglock-location}
}{
	Using a \materialref{taglock}, you may seek {\visions} of what is to befall another person.
	When you use \featref{foresight-aim-self}, you may select a person or creature for whom you have a \materialref{taglock}, rather than yourself.
	This searches for events in their vicinity, wherever they are in the future, and focuses the scrying sensor upon them.
