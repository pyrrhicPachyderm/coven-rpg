...
\subsection{Portent Targets}
\seclabel{portent-targets}

Some {\portents} use a {\portenttarget}: a creature or person about whom information is sought using the {\portent}.
If a {\portent} requires a {\portenttarget}, you must watch the {\portenttargetpossessive} behaviour while you study the {\portent}.
...
Some {\portents} allow you to use yourself as a {\portenttarget}, in which case no observation is necessary.

How the {\portenttarget} of a {\portent} is used will depend upon the {\portent}, and will be specified in the relevant feat.
...
For some types of {\portent}, the {\portenttarget} may not even appear in the {\vision}.
...
\feat{Seven for a Secret}{portent-birds-2}{15}{
	...
	Additionally, you must watch the behaviour of a person or other creature: the {\portenttarget}.
	
	This works just like \featref{portent-birds}, except that instead of seeing an event that would upset you, you see the event that the {\portenttarget} would least like you to see---an event they would want to hide from you.
	This gives the {\portenttarget} no awareness of the event to come, or even that you have used this on them at all.
...
\feat{Portents of Intersection}{portent-visit}{15}{
	...
	Additionally, you must watch the behaviour of a person or other creature: the {\portenttarget}.
	You may use yourself as the {\portenttarget}.
	
	If you use this {\portent}, you see a {\vision} of the next time the {\portenttarget} will visit the location of your {\vision}.
	...
	In most cases---unless you're using \featref{scrying} to watch someone in a different location or \featref{vision-scrying} to see a {\vision} of a different location---the {\portenttarget} will already be in the location of the {\vision}.
	In this case, the {\vision} will not just be of the present time: it will wait until the {\portenttarget} has left and returned.
}
...
\feat{Portent Tracing}{portent-aim-taglock}{15}{
	\skillref[2]{divination},
...
\feat{Instant Foresight}{foresight-speed-2}{20}{
	...
	If you are using some materials to aim \featref{foresight}, such as with \featref{portent-entrails} or \featref{portent-chance}, you must take the time required to use these---normally at least an {\action}.
