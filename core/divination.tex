...
\feat{Scrying the Minds}{scrying-mental-realm}{10}{
	...
	You can extend the sense of the {\mentalrealm} that \featref{projection-mental-realm-sense} grants you through \featref{scrying} surfaces.
	You don't even need to be able to see the scrying surface with your eyes, though it must be within your range of sensing within the {\mentalrealm}.
	
	Note that this only works while inhabiting a body, using \featref{projection-mental-realm-sense}.
	The scrying surface doesn't actually exist in the {\mentalrealm}, so you cannot use it while you are there.
}
