...
\feat{Hindsight}{hindsight}{10}{
	...
	Additionally, hindsight breaks down and automatically ends if you move too far from where you began it; you can manage a couple of metres without trouble, or more with a Test.
	
	While using hindsight, you can only see \featref{scrying} images that existed in the time and place you are looking at.
	This means that you simply cannot use it in conjunction with \featref{scrying-eyes}.
}

\feat{Freeze Frame}{hindsight-pause}{10}{
	\featref{hindsight}
}{
...
\feat{Fore-Hindsight}{hindsight-forwards}{10}{
	\skillref[1]{divination},
	\featref{hindsight-pause}
}{
...
\feat{Roam the Past}{hindsight-move}{10}{
	\featref{hindsight}
}{
	Moving around---any distance---no longer disrupts your \featref{hindsight}.
}

\feat{Hindscrying}{hindsight-scrying}{15}{
	\skillref[1]{divination},
	\featref{hindsight-move},
	\featref{scrying}
}{
	You may use \featref{hindsight} on your \featref{scrying} images, making them watch backwards in time.
	
	If you also have \featref{scrying-unattended}, you can even leave the image running using hindsight.
	However, changing the speed or pausing it (if you have the feats to do so), requires you to be near the scrying surface, just like moving the sensor.
}
...
\feat{Rapid Rewind}{hindsight-speed}{15}{
	...
	If you also have \featref{hindsight-forwards}, you can go up to this speed forwards or backwards, though never ahead of the present time.
}
...
\feat{Foretelling}{foretelling}{20}{
	None
}{
	Placeholder.
}
...
\feat{Danger Sense}{divination-initiative}{20}{
	...
	Sensing the future is easier if you don't seek the clear visions of \featref{foretelling}, but settle for a vague premonition that \emph{something} is about to happen.
