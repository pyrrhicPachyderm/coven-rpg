...
\feat{Haruspex}{foresight-entrails}{10}{
	\featref{foresight}
}{
	...
	This searches for the most violent moment within the time \featref{foresight} would normally allow you to view, as determined by the GM.
...
\feat{One for Sorrow}{foresight-birds}{15}{
	\skillref[1]{divination},
	\featref{foresight-entrails}
}{
	By watching the behaviour of a bird as you begin \featref{foresight}, you foretell sorrow.
	The bird must be {\wild}, and behaving naturally, not a familiar or captured bird.
	If you do so, then instead of specifying a time, you see a {\vision} of the event which would most upset you---typically the event you most want to avert.
	
	Just like \featref{foresight-entrails}, this searches your current location---or the current location of the scrying sensor---within the time \featref{foresight} would normally allow you to view, and you may shorten the time it searches if you wish.
}

\feat{Seven for a Secret}{foresight-birds-2}{15}{
	\skillref[1]{divination},
	...
	This requires you to watch the behaviour of many birds---at least seven---while you begin \featref{foresight}.
	Just like \featref{foresight-birds}, these must be {\wild} birds.
	Additionally, you must watch the behaviour of a person or other creature: the target.
	
	This works just like \featref{foresight-birds}, except that instead of seeing an event that would upset you, you see the event that the target would least like you to see---an event they would want to hide from you.
	This gives the target no awareness of the event to come, or even that you have used this on them at all.
	
	You can still use \featref{foresight-birds} instead of this, even if multiple birds are present; it is simple to focus on just one of them.
}

\feat{Tarot}{foresight-chance}{25}{
	\skillref[2]{divination},
	\featref{foresight}
}{
	...
	\capital{\materialrefplural{tarot}} are an instrument of chance, and using this feat \emph{always} requires a Test.
...
\feat{Portentous Place}{foresight-aim-location}{20}{
	\skillref[1]{divination},
	\featref{vision-scrying},
	\featref{scrying-speed},
	\featref{foresight-entrails} or \featref{foresight-chance}
}{
	You may use omens not just to search for a time for your \featref{foresight}, but also a place.
	To do this, you must be using \featref{vision-scrying} to begin \featref{foresight} through a scrying surface, and you must be using a feat such as \featref{foresight-entrails}, \featref{foresight-birds}, or \featref{foresight-chance} to select a time for your {\vision}.
	
	If you use this, you select an area within your scrying range to search, as well as a time ahead.
	For example, you might search within a given castle, or the entire area within your kilometre scrying range.
	When your \featref{foresight} {\vision} starts, the scrying sensor is automatically refocussed to the location of the event.
	This will never focus upon an event that happens outside your scrying range.
	
	For example, if you used this with \featref{foresight-entrails}, you might search for the most violent event upcoming within a day, and within a kilometre of you.
	If you use this with \featref{foresight-chance}, and fail, both the time and place you see are random.
}

\feat{Portentous Person}{foresight-aim-location-taglock}{10}{
	\skillref[1]{divination},
	\featref{foresight-aim-location},
	\featref{divination-taglock-location}
}{
	Using a \materialref{taglock}, you may seek {\visions} of what is to befall a person.
	When you use \featref{foresight-aim-location}, you may select a person or creature, rather than area, by using a \materialref{taglock} from them.
	This searches for events within their vicinity, even as they move around in the future.
	For example, using \featref{foresight-entrails}, you may search for the next violent event to befall the person.
	You may even use a \materialref{taglock} from yourself, to search your own future.
	
	This will still never focus on an event that happens outside your scrying range.
}
...
\feat{Instant Foresight}{foresight-speed-2}{20}{
	...
	If you are using some materials to aim \featref{foresight}, such as with \featref{foresight-entrails} or \featref{foresight-chance}, you must take the time required to use these---normally at least an {\action}.
...
\feat{Seer Slayer}{divination-vs-divination}{10}{
	...
	A fight between two \practitioners{divination} is an intricate.
	...
	You have practiced in slicing your powers as close to the critical moment as possible, to ensure you come out on top.
