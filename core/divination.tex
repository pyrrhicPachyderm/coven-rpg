...
\feat{Omens of Self}{foresight-aim-self}{10}{
	...
	For example, if you used this with \featref{foresight-entrails}, it would focus on the most violent event that occurs to you within the time period you search.
...
\feat{Temporal-Mentality}{vision-projection}{10}{
	...
	You can use \featref{hindsight} or \featref{foresight}---assuming you have them---from within the {\mentalrealm}, sensing the minds in the past or future.
