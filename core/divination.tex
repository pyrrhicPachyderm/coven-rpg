...
\featref{hindsight-foresight-move} lifts this limitation.
...
The more reliable solution is to use the feat \featref{hindsight-foresight-scrying}.
...
\feat{Rapid Rewind}{hindsight-foresight-speed}{15}{
	\skillref[1]{divination},
	...
	If you also have \featref{hindsight-foresight-bidirectional}, you can go up to this speed forwards or backwards, though never outside of the {\visionpossessive} alloted time.
}

\feat{Lightning Rewind}{hindsight-foresight-speed-2}{15}{
	\skillref[2]{divination},
	\featref{hindsight-foresight-speed}
}{
	You may accelerate your {\visions} to ludicrous speed.
	This follows the same rules as \featref{hindsight-foresight-speed}, except that you may perceive time at up to a million times the normal speed; more than ten days per second, or a century in less than an hour.
}
...
\feat{Fore-Hindsight}{hindsight-foresight-bidirectional}{10}{
	...
	The same as with \featref{hindsight-foresight-pause}, you have a moment's warning when the allotted time is about to expire, allowing you to turn and watch back the other way.
}
...
\feat{Scrying the Minds}{scrying-projection}{10}{
	...
	You cannot use this through any scrying surface that is seeing the past or future, by \featref{hindsight-foresight-scrying}, unless you also have \featref{hindsight-foresight-projection}.
}
...
\feat{Mind-Controlled Scrying}{scrying-projection-move}{10}{
	...
	If you also have \featref{hindsight-foresight-projection} and \featref{hindsight-foresight-scrying}, you can also move the sensor through time from within the {\mentalrealm}, following the usual rules.
}

\feat{Temporal-Mentality}{hindsight-foresight-projection}{10}{
	\skillref[1]{divination},
	\skillref[1]{projection},
	\featref{hindsight} or \featref{foresight},
	\featref{projection-start}
}{
	You can use \featref{hindsight} or \featref{foresight} from within the {\mentalrealm}, if you have them, sensing the minds in the past or future.
...
\feat{Temporal-Mental Leap}{hindsight-foresight-projection-start}{5}{
	\skillref[1]{divination},
	\skillref[2]{projection},
	\featref{hindsight-foresight-projection},
	\featref{hindsight-foresight-move},
...
\feat{Temporal-Mental Reading}{hindsight-foresight-projection-interface}{15}{
	\skillref[2]{divination},
	\skillref[1]{projection},
	\featref{hindsight-foresight-projection}
}{
	While you are using \featref{hindsight-foresight-projection}, you may form {\subtleinterfaces} with minds in the past or future.
