...
\feat{Haruspex}{foretelling-entrails}{10}{
	...
	This only searches for violence in your immediate surroundings---such that you would be able to see it in the {\vision} from where you stand now.
	As such, it doesn't work particularly well in combination with \featref{vision-scrying}.
}
