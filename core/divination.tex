...
\feat{Hindsight}{hindsight}{10}{
	...
	Speech is hard to interpret in reverse, requiring a \testtype{wit} Test for anything but the most simplest phrases.
...
\feat{Freeze Frame}{hindsight-pause}{10}{
	...
	You may switch at will between using hindsight normally (seeing backwards) and paused, but ending hindsight still jumps you back the present.
