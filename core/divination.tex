...
Giving precise visions, with a fixed-future model of foretelling, can then require a lot of railroading by the GM to ensure they come true.
This can impinge on the \emph{collaborative} storytelling aspect of the game.
The other option is to adopt a mutable-future model, where a witch who has seen the future can act to avert that future.
Without great care, however, this model can quickly make foretelling useless, as nothing a witch sees has any guarantee of coming to pass.
