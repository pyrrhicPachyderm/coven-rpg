...
\familiar{Bat}{bat}{15}{
	...
	Lurkers in darkness, and nocturnal fliers, bats fit right in with a certain type of witch.
	...
	\ability{Echolocation}{
		The bat can sense perfectly in darkness, or even when blinded, using its echolocation.
	...
	\familiaroption{Vampire Bat}{5}{
		The bat gains \skillref[1]{weaponry}.
		Although it's bite doesn't do any additional damage, it is painless, and can go unnoticed by the victim.
		A full feed takes about 30 minutes, but the bat can get enough blood to use as a \materialref{taglock} in just one {\action}.
		It can regurgitate this blood any time in the next few hours.
	}
}
...
\familiar{Cat}{cat}{20}{
	...
	\ability{Natural Acrobat}{
		The cat rolls an extra die on Tests to jump, retain its balance, land on its feet, or avoid {\damage} from falling.
		%TODO: Reduce fall damage in some more definite fashion?
	}
	
	\ability{Cat's Eyes}{
		The cat can see excellently in the dark.
...
\familiar{Dog}{dog}{20}{
	...
	\familiaroption{Scenthound}{5}{
		The dog rolls an extra die on \skillref{perception} Tests relying on smell.
	}
	
	\familiaroption{Greyhound}{5}{
		The dog has a \statref{speed} of \speed{20}.
	}
}

\familiar[Ferret/Stoat/Weasel]{Ferret}{mustelid}{15}{
...
\familiar[Frog/Toad]{Frog}{frog}{5}{
	\atttable{\negative 3}{\negative 1}{1}{1}{2}{0}{\negative 1}{\negative 1}
}{
	\speed{4}, \swimspeed{4}
}{
...
\familiar{Owl}{owl}{15}{
	...
	\skillref[1]{flying}, \skillref[2]{perception}
}{
	The great wisdom of owls makes them well suited to those witches who enjoy a spot of intellectual conversation, and can't find any other humans who seem to be up to it.
	They also make excellent nocturnal scouts, and even hunters.
}{
	\ability{Night Eyes}{
		The owl can see excellently in the dark.
		It suffers no penalties in low-light conditions, though it is as blind as anyone in complete darkness.
	}
	
	\ability{Swoop}{
		The owl rolls 3 dice for unarmed {\damagetests}, when striking from a dive.
	}
}

\familiar[Raptor (Eagle/Falcon/Hawk)]{Raptor}{raptor}{25}{
	\atttable{\negative 1}{3}{1}{2}{2}{3}{\negative 1}{2}
}{
	\speed{2}, \flyspeed{20}
}{
	...
	Raptors include buzzards, eagles, falcons, harriers, hawks, kites, and osprey; birds of prey.
	They are excellent fliers, have keen eyesight, and nobody would want to tangle with their wicked beak and talons.
	Among the nobility, falconry is largely a status symbol, but a witch with a raptor for a familiar has herself a great asset.
}{
	\ability{Eagle Eyes}{
...
\familiar[Rat/Mouse]{Rat}{rat}{0}{
	...
	\ability{Keen Smell}{
		The rat rolls an extra die on \skillref{perception} Tests relying on smell.
	}
}
