...
\familiar{Cat}{Cats}{cat}{20}{
	...
	\ability{Claws}{
		The \familiarref{cat} rolls 3 dice for unarmed {\damagetests}.
	}
}
...
\familiar[Ferret/Stoat/Weasel]{Ferret}{Ferrets}{ferret}{15}{
	...
	\ability{Bite}{
		The \familiarref{ferret} rolls 3 dice for unarmed {\damagetests}.
	}
...
\familiar{Owl}{Owls}{owl}{15}{
	...
	\ability{Swoop}{
		The \familiarref{owl} rolls 3 dice for unarmed {\damagetests}, when striking from a dive.
	}
}
