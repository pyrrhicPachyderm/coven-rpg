...
Some can make \weaponref{unarmed} attacks, and the number of dice they roll for their {\damagetests} are given in their list of abilities.
...
\familiar{Bat}{Bats}{bat}{15}{
	...
	\familiaroption{Vampire Bat}{5}{
		The \familiarref{bat} gains \skillref[1]{weaponry}, and it rolls 1 die for \weaponref{unarmed} {\damagetests}.
		Its bite is painless, and can go unnoticed by the victim.
		A full feed takes about 30 minutes, but it draws enough blood to use as a \materialref{taglock} in just one {\action}---even if it deals no {\damage}.
...
\familiar{Cat}{Cats}{cat}{20}{
	...
	\ability{Claws}{
		The \familiarref{cat} rolls 2 dice for \weaponref{unarmed} {\damagetests}.
	}
}
...
\familiar{Dog}{Dogs}{dog}{20}{
	...
	\familiarrefplural{dog} are a diverse lot, including hunting dogs, sheepdogs, sled dogs and more.
}{
	\ability{Bite}{
		The \familiarref{dog} rolls 5 dice for \weaponref{unarmed} {\damagetests}.
	}
...
\familiar[Ferret/Stoat/Weasel]{Ferret}{Ferrets}{ferret}{15}{
	...
	\ability{Bite}{
		The \familiarref{ferret} rolls 2 dice for \weaponref{unarmed} {\damagetests}.
	}
	
	\ability{Slippery}{
		The \familiarrefpossessive{ferret} \statref{dr} is increased by 2.
	}
}
...
\familiar[Frog/Toad]{Frog}{Frogs}{frog}{0}{
	...
	\familiarrefplural{frog} and toads make excellent companions to brewing witches, due to their natural affinity with water.
...
\familiar{Owl}{Owls}{owl}{15}{
	...
	\ability{Swooping Talons}{
		The \familiarref{owl} rolls 2 dice for \weaponref{unarmed} {\damagetests}, or 3 dice when striking from a dive.
	}
}
...
\familiar[Raptor (Eagle/Falcon/Hawk)]{Raptor}{Raptors}{raptor}{25}{
	...
	\familiarrefplural{raptor} include buzzards, eagles, falcons, harriers, hawks, kites, and osprey; birds of prey.
	...
	\ability{Beak \& Talons}{
		The \familiarref{raptor} rolls 3 dice for \weaponref{unarmed} {\damagetests}, or 4 dice when striking from a dive.
	}
}
