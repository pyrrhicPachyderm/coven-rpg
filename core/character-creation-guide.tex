...
Diversity can also be good: make sure you know what you're letting yourselves in for if \emph{everybody} in the group wants to play a potion-brewer.
...
\statlabel{Resilience}{Resiliences}{res}
\statlabel{Shock Threshold}{Shock Thresholds}{st}
\statlabel{Dodge Rating}{Dodge Ratings}{dr}
\statlabel{Speed}{Speeds}{speed}
