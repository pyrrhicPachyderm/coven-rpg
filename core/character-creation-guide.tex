...
Feats can be found in the chapters of \partref{disciplines}.
...
Every feat lists its cost as part of its description.
However, feats from some disciplines are cheaper if you are sufficiently advanced in the skill that governs that discipline.
