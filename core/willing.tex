...
\feat{Flash Forming}{willing-water-combine}{20}{
	...
	For example, you could condense a mass of water, shape it into a sword, freeze it, and make an \actionref{attack} using the sword, as one {\action}.
...
\feat{Redirection}{willing-wind-defend-3}{15}{
	...
	When you cause an attack to miss with \featref{willing-wind-defend} or \featref{willing-wind-defend-2}, you may use the airborne projectile to make an \actionref{attack} against another target within the weapon's range.
