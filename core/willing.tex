...
\feat{Hand of Fate}{willing-chance}{15}{
	...
	When you roll dice, draw cards from a deck, or the like, you may force the result.
...
\feat{Arm of Fate}{willing-chance-2}{10}{
	...
	You may use \featref{willing-chance} to force the result when someone else rolls the dice, draws the cards, or the like, as long as you can see them doing it.
}
