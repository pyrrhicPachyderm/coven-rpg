...
\feat{Dig}{willing-earth}{10}{
	...
	You can affect up to a cubic metre at a time, in one connected chunk that reaches no more than 2 metres from you.
	...
	However, you can move chunks of earth with enough force to use them as \weaponrefplural{club}, and may even draw them from the ground in the same {\action} as you \actionref{attack}.
}
...
\feat{Burrow}{willing-earth-tunnel}{15}{
	...
	The tunnel is only stable with a diameter of up to one metre, and hence acts as {\difficultterrain} for a human.
	You can extend the tunnel by one metre as an {\action}, while touching the face.
...
\feat{Rockmover}{willing-rock}{10}{
	...
	Rocks are harder than mere dirt, and more difficult to affect.
	But in a way, they are simpler, being formed from one big piece instead of many small ones.
...
\feat{Erosion}{willing-destruction}{15}{
	...
	You can affect about a cubic metre at a time, stretching no more than 2 metres from you.
...
\feat{Shatter}{willing-destruction-earth}{15}{
	...
	As an {\action}, you can destroy up to a cubic metre of rock that you touch, in one connected mass that stretches no more than 2 metres from you.
	...
	Unless you also have \featref{willing-earth-tunnel}, the shattering has a tendency to collapse large overhangs or rooves, making this useless for tunneling.
	With \featref{willing-earth-tunnel}, however, this allows you to tunnel through solid rock.
}
