...
\feat{Dig}{willing-earth}{10}{
	...
	However, you can move chunks of earth with enough force to use them as \weaponrefplural{clubs}, and may even draw them from the ground in the same {\action} as you {\attack}.
}
