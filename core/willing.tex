...
\feat{Fan the Flames}{willing-fire-2}{15}{
	...
	As an {\action}, you may double the size of an ex fire within a dozen metres of you.
...
\feat{Firestarter}{willing-fire-3}{20}{
	...
	If you ignite a person's clothes, they must intentionally try to extinguish themselves to avoid it catching, typically using an {\action}.
}
...
\feat{Condensation}{willing-water-vapour}{10}{
	...
	You can draw it out within a couple of metres, into a container, spilling it on the ground, or holding it using \featref{water-willing}.
	You may also discharge liquid water into the air in the same way, at the same rate.
...
\feat{Puff}{willing-wind}{15}{
	\featref{willing-basic}
}{
	Your mind can stir the air around you.
	You can create small air movements within a dozen metres.
	Very minor and imprecise effects, like blowing hair, don't require much effort.
	Moving something more substantial, such as an empty sack, or moving something with precision, requires the concentration of an {\action}.
	Anything that wouldn't obviously catch the wind is too heavy to move with this effect, although you might still be able to disturb it with a Test.
}

\feat{Gust}{willing-wind-2}{15}{
	\skillref[1]{willing},
	\featref{willing-wind}
}{
	You can evoke larger gusts about you.
	When you use \featref{willing-wind} as an {\action}, you may produce strong enough to wind to affect heavier objects.
	You can produce enough wind to send dishes flying, or to set a rock slowly rolling.
	With a Test, you might even produce enough of a gust to knock a person down, and certainly enough to slow their movement in a particular direction.
	The effect still remains fairly localised; you can't shift enough air to blow at anything larger than a person.
}
...
\feat{Gusty Leap}{willing-wind-self}{15}{
	\skillref[1]{willing},
	\featref{willing-wind}
}{
...
\feat{Updraft}{willing-wind-others}{15}{
	\skillref[2]{willing},
	\featref{willing-wind-self}
}{
...
\feat{Breeze}{willing-wind-aoe}{15}{
	\skillref[1]{willing},
	\featref{willing-wind-2}
}{
	You can alter the direction and strength of the wind within a dozen metres of you.
...
\feat{Long-Winded}{willing-wind-range}{20}{
	...
	You may ignore the range limitation for \featref{willing-wind}, \featref{willing-wind-2} and \featref{willing-wind-others}.
...
\feat{Weather}{willing-weather-2}{20}{
	...
	You cannot create winds stronger than those achievable using \featref{willing-weather-aoe-2}.
