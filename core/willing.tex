\discipline{Willing}{willing}{Willer}{Willers}

\dropcapdiscref{willing} is the most raw and versatile application of a witch's magic.
...
It involves wilfully deceiving not only oneself, but also the very universe.
...
One interesting property of \discref{willing} is that it cannot directly affect living people, plants, or animals (or even undead, or golems), although you can affect yourself.
...
\capital{\discref{willing}} is not about memorising rites or recipes, nor about complexities and intricacies; \attref{ken} and \attref{wit} are unimportant to most applications of \discref{willing}.
...
\section{Feats}
\setfeatdefault{discipline}{willing}{false}
\unsetfeatdefault{tags}

\feat{Basic Willing}{willing-basic}{5}{
	\noprereq
}{
	...
	\end{itemize}
	The amount of time required to produce an effect depends on the desired outcome, but should be more than an {\action} without a {\test}.
...
\feat{Kindling}{willing-fire}{15}{
	...
	You've practised \discref{willing} a fire to life, and it's getting a lot easier for you.
...
\feat{Fan the Flames}{willing-fire-2}{15}{
	...
	As an {\action}, you may double the size of an existing fire within a dozen metres of you, growing it to ignite a larger area.
	However, this is less effective on large fires: you can't ignite more than about a cubic metre of a material in one {\action}.
	...
	A campfire affected in such a way is hot enough to forge iron, or fire clay.
}
...
\feat{Extinguish}{willing-extinguish}{15}{
	...
	Your experience working with fire allows you to extinguish it as easily as you light it.
...
\feat{Heatsink}{willing-extinguish-3}{10}{
	\skillref[3]{willing},
...
\feat{Bubbling Brook}{willing-water}{10}{
	...
	You can only affect a couple of buckets-full (about 20 litres) at a time, and can't stretch it out over more than a couple of metres.
	...
	Idly carrying around a bubble of water requires little concentration, but shaping it, or doing much besides just carrying it, requires an {\action}.
}
...
\feat{Water Walk}{water-walk}{20}{
	...
	Staying upright on fast flowing or turbulent water may require a {\test}, and the effect requires you to stay on your feet; falling prone will cause you to fall into the water.
...
\feat{Condensation}{willing-water-vapour}{10}{
	...
	In some situations, such as a desert or a burning building, the GM may call for a {\test} to gather enough water to be useful at all.
...
\feat{Flash Condensation}{willing-water-vapour-2}{15}{
	\skillref[1]{willing},
	\featref{willing-water-vapour}
}{
	You can gather a lot of water from a lot of air, very quickly.
	When you use \featref{willing-water-vapour}, you can affect two buckets-full (about 20 litres) in one {\action}, under normal conditions.
	Condensing this much water will normally exhaust all the water vapour in a room, in one go.
	
	Using this, you can perform \discref{brewing} that would normally require a \mixcreationref{still} as fast as though it only required a \mixcreationref{cauldron}.
}

\feat{Boil}{willing-water-boil}{15}{
	\skillref[1]{willing},
	\featref{willing-fire},
	\featref{willing-water-vapour}
}{
	\capital{\featref{willing-water-vapour}} merely lets you \emph{evaporate} water.
	Now you can \emph{boil} it.
	
	As an {\action}, you can heat, to any temperature up to boiling point, up to two buckets-full (about 20 litres) of water within a couple of metres.
	You can also melt a similar volume of ice or snow, bringing it up to room temperature.
	You can also affect any water-based substances that you could affect with \featref{willing-water}.
	You can boil a cauldron in an {\action} or two; useful for \discref{brewing}.
	
	Touching boiling water---which you have to do to use \featref{willing-water} on it---deals a \dice{1} {\damagetest} every {\turn}.
	Having a full bucket or two of boiling water splashed over you deals a \dice{3} {\damagetest}.
}

\feat{Freeze}{willing-water-freeze}{10}{
	\skillref[1]{willing},
	\featref{willing-extinguish},
	\featref{willing-water-vapour}
}{
	The opposite of \featref{willing-water-boil}, you can chill water.
	As an {\action}, you can chill or freeze up to two buckets-full (about 20 litres) of water within a couple of metres.
	You can also affect any water-based substances that you could affect with \featref{willing-water}.
	By shaping the water first, using \featref{willing-water}, you can create instant ice sculpture.
}

\feat{Flash Forming}{willing-water-combine}{20}{
	\skillref[2]{willing},
	\featref{willing-water-vapour-2} or \featref{willing-water-boil} or \featref{willing-water-freeze}
}{
	You are a practised \practitioner{willing} of water.
	You can use \featref{willing-water}, \featref{willing-water-vapour-2}, \featref{willing-water-boil}, and/or \featref{willing-water-freeze} as part of the same {\action}, as long as you are using them all on the same mass of water.
	You must have all the feats you use, of course.
	
	You can even do all of these as part of a normal {\action} using the same mass of water.
	
	For example, you could condense a mass of water, shape it into a sword, freeze it, and make an attack using the sword, as one {\action}.
	An ice sword isn't very robust, of course, so you may need to do it all again next {\turn}.
}
...
\feat{Gust}{willing-wind}{20}{
	...
	With a {\test}, you might even produce enough of a gust to knock a person down.
...
\feat{Updraught}{willing-wind-self}{15}{
	\featref{willing-wind}
}{
	By surrounding yourself in a localised updraught, you can leap higher and slow yourself as you fall.
...
\feat{Team Lift}{willing-wind-others}{15}{
	...
	You may extend your own updraught to surround those around you.
...
\feat{Breeze}{willing-wind-aoe}{15}{
	...
	\capital{\featref{willing-wind}} produces only small gusts, to blow at one person or object.
...
\feat{Long-Winded}{willing-wind-range}{20}{
	...
	You may ignore the range limitation for \featref{willing-wind}, \featref{willing-wind-others}, \featref{willing-voice-2}, and \featref{willing-wind-blowgun}.
...
\feat{Amplify}{willing-voice}{15}{
	...
	\capital{\discref{willing}} the air around you, you can push your voice louder and further.
	When you speak, sing, whistle or so on, you may make it up to twice as loud.
	However, you may also make it carry far further---up to a kilometre---even if you choose not to make it louder.
}
...
\feat{Ventriloquism}{willing-voice-2}{20}{
	...
	Consequently, you need not speak from the position of you own mouth, but can speak from anywhere within a dozen metres.
...
\feat{Silence}{willing-silence}{20}{
	...
	You may prevent any sound escaping from yourself, silencing your voice, your breathing, your footsteps, and so on.
...
\feat{Dead Air}{willing-silence-2}{15}{
	...
	You may extend your bubble of silence to cover the same area you may affect with \featref{willing-wind-aoe}.
	No sound can originate within, enter, or pass through this region.
}

\feat{Blow}{willing-wind-blowgun}{10}{
	\featref{willing-wind}
}{
	You can use \discref{willing} to push air down your \weaponref{blowgun}, instead of your breath.
	This allows you to fire any loaded \weaponref{blowgun} within a dozen metres as an {\action}.
	You must still be holding the \weaponref{blowgun} to \emph{aim} at all---unless you also have \featref{willing-wind-weapons-2}.
	
	Furthermore, your will is more powerful than your breath.
	You may roll the {\damagetest} using your \skillref{willing} skill in place of the \weaponrefpossessive{blowgun} damage dice.
	For example, if you have \skillref[1]{willing}, you would roll \dice{4}.
	Obviously, this carries no benefit if you have no \skillref{willing} skill.
}
...
\feat{Guided Missile}{willing-wind-weapons}{15}{
	...
	You may use your \skillref{willing} skill in place of your \skillref{weaponry} skill when attacking with a thrown or ranged weapon.
}

\feat{Curving Arrow}{willing-wind-weapons-2}{20}{
	\skillref[3]{willing},
	\featref{willing-wind-weapons}
}{
	\capital{\discref{willing}} a stronger wind, you can shoot around corners.
	When you attack with a thrown or ranged weapon, you can make the projectile turn corners in mid-air.
	This allows you to hit targets behind cover, but you take a large penalty to the {\test} to hit them if you cannot see them.
	In combination with \featref{scrying}, it can be deadly.
	
	The range of the weapon still limits the maximum distance the projectile can travel.
	Pulling particularly outlandish tricks---such as turning a shot \SI{180}{\degree}, or passing it through a narrow hole---may require a \testtype{will}{willing} {\test} in addition to the {\test} to hit.
}

\feat{Far Shot}{willing-wind-weapons-range}{10}{
	\skillref[1]{willing},
	\featref{willing-wind-weapons},
	\featref{willing-wind-range}
}{
	The air buoys your projectiles, carrying them further.
	Quadruple your range when attacking with a thrown or ranged weapon.
}

\feat{Carry Arrow}{willing-wind-weapons-range-2}{15}{
	\skillref[2]{willing},
	\featref{willing-wind-weapons-range}
}{
	Your wind is strong enough to simply carry your projectiles.
	Your range is unlimited when attacking with a thrown or ranged weapon.
	However, you must be able to see the target, and the projectile's whole path to it.
	Furthermore, the projectile must still travel in a typical arc; you need \featref{willing-wind-weapons-2} to shoot around corners.
}

\feat{Deflect Missiles}{willing-wind-defend}{20}{
	\skillref[1]{willing},
	\featref{willing-wind-weapons},
	\featref{willing-wind-range}
}{
	You can use the air to deflect projectiles.
	Activating this effect requires an {\action}, and it lasts until the end of your next turn.
	When you activate it, focus on a person, creature, or other target that you can see; it must remain in sight for the effect to remain active.
	You can cause any attack with a thrown or ranged weapon made \emph{by} the target, or \emph{against} it, to automatically miss.
	You may defend yourself with this.
}

\feat{Shield of Air}{willing-wind-defend-2}{15}{
	\skillref[2]{willing},
	\featref{willing-wind-defend},
	\featref{willing-wind-aoe}
}{
	You may extend your wind to protect an area.
	When you use \featref{willing-wind-defend} you may focus on the area around yourself, instead of a particular target.
	If you do so, you may affect any attack with a thrown or ranged weapon that passes within a dozen metres of you.
	This includes any attacks made by, or against, creatures within that range, as well as those that fly through the area.
}

\feat{Redirection}{willing-wind-defend-3}{15}{
	\skillref[3]{willing},
	\featref{willing-wind-defend-2},
	\featref{willing-wind-weapons-2}
}{
	You can turn your foes arrows back against them.
	When you cause an attack to miss with \featref{willing-wind-defend} or \featref{willing-wind-defend-2}, you may use the airborne projectile to make an attack against another target within the weapon's range.
	Make a {\test} to hit, using your \skillref{willing} skill and the weapon's accuracy.
	
	Use the original attacker's \attref{might}, or the original \weaponrefpossessive{bow} draw weight, to determine the range and {\damage}, if necessary.
	You may use \featref{willing-wind-weapons-2} on the redirected attack, as well as \featref{willing-wind-weapons-range}, and \featref{willing-wind-weapons-range-2}, if you have them.
}
...
\feat{Dig}{willing-earth}{10}{
	...
	You can move chunks of earth with enough force to use them as \weaponrefplural{club}, and may even draw them from the ground in the same {\action} as you attack.
...
\feat{Burrow}{willing-earth-tunnel}{15}{
	...
	You may burrow only though earth---tunnelling through rock requires \featref{willing-destruction-earth}.
}
...
\feat{Shatter}{willing-destruction-earth}{15}{
	...
	Unless you also have \featref{willing-earth-tunnel}, the shattering has a tendency to collapse large overhangs or roofs, making this useless for tunnelling.
...
\feat{Illuminuous}{willing-light}{10}{
	...
	Your bright or gloomy moods are more literal than most, as \discref{willing} makes your surroundings brighter or darker.
	This effects a region centred on you and extends up to a few metres, enough to fill a room in a cottage.
...
\feat{A Tool for the Job}{willing-tools-improvise}{20}{
	...
	Sometimes, the easiest way to convince someone of something is to hit them with a big stick until they agree with you.
	...
	For a worse approximation, this may require a {\test}.
	A solid branch with a flat, sort of axe head shaped bit on the end will do a fine job of cutting down a tree.
	A solid branch without such an attachment would require a {\test}.
...
\feat{A Hefty Tool}{willing-tools}{15}{
	\featref{willing-basic}
}{
...
\feat{Crack}{willing-rope-noise}{10}{
	\skillref[2]{willing},
	\featref{willing-rope},
	\featref{willing-voice}
}{
	When you crack a whip, you can make it \emph{deafening}.
	It is audible up to about 30 kilometres away, and anyone within a dozen metres is deafened for a minute by the ringing in their ears---including you.
}

\feat{Hand of Fate}{willing-chance}{15}{
	\skillref[1]{divination},
	\featref{willing-basic}
}{
	With \discref{divination} to know what to do, and \discref{willing} to do it, chance itself becomes your plaything.
	When you toss coins, roll dice, draw cards from a deck, or the like, you may force the result.
	You may only force a result that would normally be possible; for example, you can't draw the same card twice from a deck, unless you put it back after the first time.
	
	This only applies in character, of course.
	You still have to roll the dice for your {\tests}.
}

\feat{Arm of Fate}{willing-chance-2}{10}{
	\skillref[1]{willing},
	\skillref[1]{divination},
	\featref{willing-chance}
}{
	You may stretch the hand of fate beyond your own fingertips.
	You may use \featref{willing-chance} to force the result when someone else tosses the coin, rolls the dice, draws the cards, or the like, as long as you can see them doing it.
}
