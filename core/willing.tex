...
\feat{Curving Arrow}{willing-wind-weapons-2}{20}{
	...
	This allows you to hit targets behind cover, but you take a large penalty to the Test to hit them if you cannot see them.
	...
	Pulling particularly outlandish tricks---such as turning a shot \SI{180}{\degree}, or passing it through a narrow hole---may require a \testtype{will}{willing} Test in addition to the Test to hit.
}
...
\feat{Redirection}{willing-wind-defend-3}{15}{
	...
	Make a Test to hit, using your \skillref{willing} skill and the weapon's accuracy.
...
\feat{Hand of Fate}{willing-chance}{15}{
	...
	You still have to roll the dice for your Tests.
}
