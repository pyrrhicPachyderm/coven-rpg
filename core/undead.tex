...
\undead{Ghoul}{Ghouls}{ghoul}{
	...
	Reanimating a corpse as a \undeadref{ghoul} requires that it is unrotted.
	...
	An uncontrolled \undeadref{ghoul} seeks out the flesh of its own kind to eat, instead of the food it would normally, and will kill to acquire it.
...
\undead{Draugr}{Draugar}{draugr}{
	...
	\capital{\undeadrefplural{draugr}} are often used to guard ancient tombs, sealed inside where water cannot intrude.
}
...
\undead{Blazing Skeleton}{Blazing Skeletons}{fire-skeleton}{
	...
	Firstly, the bones used to create it must be charred by fire.
...
\undead{Shade}{Shades}{shade}{
	...
	Although this makes it harder for it to affect the world, it also affords the \undeadref{shade} a degree of protection.
