...
\creature{Dog}{Dogs}{dog}{
	...
	\ability{Bite}{
		The dog rolls 5 dice for \weaponref{unarmed} {\damagetests}.
	}
}
...
\creature{Horse}{Horses}{horse}{
	...
	\ability{Hooves}{
		The horse rolls 3 dice for \weaponref{unarmed} {\damagetests}.
	}
}
...
\creature[Raptor (Eagle/Falcon/Hawk)]{Raptor}{Raptors}{raptor}{
	...
	\ability{Beak \& Talons}{
		The raptor rolls 3 dice for \weaponref{unarmed} {\damagetests}, or 4 dice when striking from a dive.
	}
}
...
\creature{Bear}{Bears}{bear}{
	...
	\ability{Bite \& Claws}{
		The bear rolls 5 dice for \weaponref{unarmed} {\damagetests}.
	}
}
