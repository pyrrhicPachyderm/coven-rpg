...
\creature[Raptor (Eagle/Falcon/Hawk)]{Raptor}{raptor}{
	\atttable{\negative 1}{3}{\negative 3}{\negative 2}{2}{3}{\negative 3}{2}
}{
	\speed{2}, \flyspeed{20}
}{
...
\creature{Moly}{moly}{
	...
	The seeds within its belly soon germinate, and the next generation of Molies flourish, using the creature's rotting corpse as compost.
	...
	\ability{Plant}{
		The \creatureref{moly} cannot move---not even a limb---or speak.
	}
	
	\ability{Projection}{
		The \creatureref{moly}'s mind automatically enters the {\mentalrealm} when its plant body dies.
