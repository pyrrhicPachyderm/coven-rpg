...
This assumes a sigil drawn in chalk at a reasonable size: no smaller than a palm and no larger than the \practitionerpossessive{sigil-magic} arm span.
...
\section{Feats}
\setfeatdefault{discipline}{sigil-magic}{false}
...
\feat{Mark of Ignition}{sigil-fire}{15}{
	...
	If the object is flammable, the marked surface erupts with flame.
	If the object is not flammable, the {\sigilmark} will have no effect.
	This can only affect non-living objects, not people, animals, or living plants.
	
	The size of this {\sigilmark} does not limit the size of object it can affect.
	Instead, the flame begins at the size of the {\sigilmark}, although it will spread from there across a flammable object.
