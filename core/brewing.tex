...
\feat{Projection Powder}{projection-potion}{15}{
	\skillref[1]{brewing},
	\featref{garlic-potion},
	\featref{projection-start}
}{
	\mix{still}{snuff}{\Herb{garlic}{2}, \herb{morning glory}{3}}
	%Morning Glory is an Aztec entheogen.
	
	This powder has enough kick to knock the mind right out of the body.
	When taken, it immediately ejects the drinker's mind into the {\mentalrealm}.
}
...
\feat{Medium's Powder}{medium-potion}{10}{
	\skillref[1]{brewing},
	\featref{projection-potion},
	\featref{medium}
}{
	By brewing the herb used to enter a \featref{medium} trance into the right concoction, you can skip the tedious meditating.
	Or use it on someone else, if you like.
	
	\mix{still}{snuff}{\Herb{garlic}{2}, \herb{morning glory}{3}, \herb[stinking nightshade]{black henbane}{2}}
	
	When taken, this concoction immediately ejects the drinker's mind into the {\mentalrealm} and places their body into a \featref{medium} trance.
...
\feat{Hair of the Dog}{brewing-healing-taglock}{20}{
	...
	This allows you to heal all the {\damage} dealt by the creature whose \materialref{taglock} is used in creatuing the poultice.
...
\feat{Universal Antidote}{antidote-all}{15}{
	\skillref[3]{brewing}
}{
	...
	%The toadbrain is firstly a reference to toadstones, supposedly an antidote to any poison.
