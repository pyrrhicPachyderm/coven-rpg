...
\feat{Ironhide Brew}{resilience-potion-3}{15}{
	...
	Using the legendary strength of the ironwood tree, you can grow a skin that will nearly turn knives.
	
	\mix{cauldron}{drink}{\Herb{parsnip}{2}, \herb{ironwood}{5}}
...
\feat{Supple Hide}{resilience-potion-supple}{15}{
	...
	The growths produced by your \featref{resilience-potion} are more supple, less restrictive.
	It reduces \attref{grace} by only 1.
}
...
\feat{Rapid Hide}{resilience-potion-fast}{15}{
	...
	Your \featref{resilience-potion} is more potent, faster-acting.
	It takes effect in only 1 round.
}
