...
\mixdelivery{Spike}{spike}{
	...
	It can be drunk willingly, as an {\action}, but typically isn't.
...
Withdrawal effects (such as those of \featref{mental-stimulant}), are not ended by an {\antidote}.
...
\section{Feats}
\setfeatdefault{discipline}{brewing}{false}
...
\feat{Alertness Potion}{heed-potion}{20}{
	\noprereq
}{
	\mix{cauldron}{drink}{\Herb{hawthorn}{2}}
	%The smell of hawthorn is triethylamine, used in many chemical syntheses.
	
	This potion causes a sustained, low-level fear response in the drinker.
	They become more alert, but correspondingly twitchy and nervous.
	The drinker gains 1 \attref{heed} for a few hours, and loses 2 \attref{will} for the same duration.
	A second dose causes irrational fear of even non-threatening things, decreasing \attref{will} by a further 2 points without increasing \attref{heed}.
	Further doses turn the target into a gibbering idiot, overcome by terror of everything.
}
...
\feat{Hysterical Strength}{physical-stimulant}{15}{
	...
	Strenuous activity includes the \actionref{dash} and \actionref{attack} {\actions}, any {\test} using \attref{might} or \attref{grace}, and other things at the GM's discretion.
	You may suffer this {\damagetest} at most once per {\round}.
...
\feat{Hysterical Empowerment}{physical-stimulant-3}{20}{
	...
	The potion provides this number as a bonus to both \attref{might} and \attref{grace}, but this also determines the number of dice rolled on the {\damagetests} it causes.
...
\feat{Berserker Broth}{rage-potion}{15}{
	...
	The drinker will not plan or delay their murders; they would rather draw a weapon and charge in than lay an ambush.
	They still have a sense of self-preservation, but it is a second priority, behind murder.
	Thankfully, however, the potion does not instil any desire to extend its own effect, even if doing so would give more time to murder people.
	
	If a player character drinks this, the GM \emph{may} allow them to keep control of their character, as long as they act in an appropriate fashion.
...
\feat{Flaming Phlegm}{fire-attack-potion}{15}{
	...
	Drinking this potion has no immediate drawbacks, although flammable saliva does carry some obvious risks.
...
\feat{Fire Breath}{fire-attack-potion-area}{15}{
	...
	And, unless they give a big puff of breath, the flame only stretches to about arm's length.
...
\feat{Toxic Infusion}{poison-potion}{10}{
	\noprereq
}{
	\mix{cauldron}{spike}{\Herb{hemlock}{2}}
	
	This infusion is a potent and fast-acting poison.
	It takes effect after 1 {\round}, whereupon the drinker suffers a \dice{3} {\damagetest}.
}

\feat{Acute Toxicity}{poison-potion-fast}{10}{
	\noprereq
}{
	By adding \herb[deadly nightshade]{belladonna}{2} to your \featref{poison-potion}, you can make it act more quickly.
	A \featref{poison-potion} brewed this way causes its {\damagetest} immediately upon ingestion, rather than after one {\round}.
	Thus, a victim has no opportunity to vomit to ameliorate its effects.
}
...
\feat{Haematemetic}{vomit-potion-blood}{10}{
	\featref{poison-potion-fast},
	\featref{vomit-potion}
}{
	\mix{cauldron}{spike}{\Herb{mistletoe}{2}, \herb{bloodwort}{2}}
	
	This vicious poison damages the stomach lining even as causes the victim to vomiting, causing them to throw up \materialref{blood}.
	It works as \featref{vomit-potion}, except that the drinker also suffers a \dice{3} {\damagetest} when they ingest the potion.
	Furthermore, their vomit contains \materialref{blood}.
	A human typically throws up 1 dose of \materialref{blood} in their vomit, though it may be hard to gather it all up if you intend to use it.
}

\feat{Potent Toxicity}{poison-potion-2}{10}{
	\skillref[1]{brewing},
	\featref{poison-potion-2}
}{
	You have learned how to concentrate your \featref{poison-potion}, making it more potent.
	When you brew a \featref{poison-potion} or \featref{vomit-potion-blood}, you may brew it such that it causes a \dice{5} {\damagetest}.
}

\feat{Extreme Toxicity}{poison-potion-3}{10}{
	\skillref[2]{brewing},
	\featref{poison-potion-2}
}{
	You can concentrate your \featref{poison-potion} to an extreme degree, making it very deadly.
	When you brew a \featref{poison-potion} or \featref{vomit-potion-blood}, you may brew it such that it causes a \dice[4]{5} {\damagetest}.
}

\feat{Chronic Toxicity}{poison-potion-ongoing}{10}{
	\featref{poison-potion}
}{
	While a \featref{poison-potion} is a fast-acting, someone who survives the acute effects is in little long-term danger.
	By adding \herb[monkshood]{wolfsbane}{3}, you can make it more dangerous.
	
	When you brew a \featref{poison-potion} with \herb[monkshood]{wolfsbane}{3}, it does not change the {\damagetest} it causes.
	However, the drinker will suffer heart failure over the course of the next few hours, leading to death.
	Vomiting after the initial {\damagetest} but before the poison's other effects may help, giving some chance of survival.
	As such, this modification doesn't work for a \featref{vomit-potion-blood}, which would cause vomiting before the poison's long-term effects kick in.
}

\feat{Subtle Toxin}{poison-potion-subtle}{10}{
	\skillref[1]{brewing},
	\featref{poison-potion-ongoing}
}{
	While \featref{poison-potion-ongoing} lets you brew a potion that will kill someone, it's not subtle in its action.
	Sometimes, you'd prefer they get no warning that they've been poisoned until they're well on the way to dying.
	
	\mix{cauldron}{spike}{\Herb[monkshood]{wolfsbane}{3}}
	
	This potion takes effect over the course of a few hours, leading to the death of the drinker by heart failure.
	It is subtle when first ingested, and should give no sign of anything wrong for at least half an hour, by which time vomiting will be of limited effectiveness.
}
...
\feat{Fear Drops}{poison-fear}{10}{
	\featref{heed-potion}
}{
	\mix{cauldron}{spike}{\Herb{coriander}{2}}
	
	Enhancing the fear response produced by the \featref{heed-potion}, these drops elicit terror in the drinker.
	The response lasts about an hour, and causes the victim to be nervous, constantly on edge, and very easily terrified.
	They will likely try to hide away from the world, will be unable to cope with anything particularly scary, and \skillref{intimidation} {\tests} against them may be far easier.
}
...
\feat{Regrowth Potion}{brewing-healing-regrow}{10}{
	\skillref[2]{brewing},
	\featref{brewing-healing-2} or \featref{brewing-healing-taglock}
}{
	Salamanders have the incredible ability to regrow lost limbs.
	By adding a salamander's leg to the recipe for your \featref{brewing-healing-2}, \featref{brewing-healing-3}, or \featref{brewing-healing-taglock}, you can grant the same ability to the drinker.
	...
	\capital{\featref{brewing-healing-taglock}} will only regrow parts that were removed by the {\unarmed} attacks of the creature whose \materialref{taglock} is used in creature.
}

\feat{Suspended Potion}{potion-delay}{10}{
	\noprereq
}{
	When you brew a \mixdeliveryref{drink}, you can suspend the active ingredients, such that they take longer to digest and take effect when drunk.
	This requires you to add some animal fat while brewing the mixture, and always requires the use of a \mixcreationref{cauldron} or \mixcreationref{still}, even if the original mixture was easier to create.
	
	You may choose any period up to 24 hours by which to delay the effect, though you cannot make the potion take effect more quickly than it normally would.
	Timing the delay is also far from precise.
	By default, the actual delay may be up to \SI{50}{\percent} shorter or longer than the intended delay.
	For example, a mixture designed to take effect after two hours may take effect anywhere from one to three hours after being drunk.
	This accuracy can be improved with a {\test}, but doing so requires knowing who will drink the mixture---in particular knowing how much they weigh.
	
	As the mixture takes longer to kick in, the drinker will usually have longer to vomit to expel it.
	Vomiting normally remains effective from when the mixture is drunk until the mixture takes effect.
	However, if the mixture's effect is delayed for longer than a few hours, vomiting will only be effective within the first few hours.
	After that period, the mixture has passed their stomach, and vomiting will have no effect on it.
}

\feat{Extended Suspension}{potion-delay-2}{15}{
	\skillref[2]{brewing},
	\featref{potion-delay}
}{
	A \featref{potion-delay} will normally be eliminated from the body within 24 hours.
	But you have learned a trick to make it persist far longer than that.
	When you use \featref{potion-delay}, you may brew the mixture to have its effect delayed by up to a month.
	As usual, longer delays lead to less accurate release times.
}

\feat{Suspended Spike}{potion-delay-spike}{15}{
	\skillref[1]{brewing},
	\featref{potion-delay}
}{
	Sometimes, when poisoning someone, it's good to give yourself time for a getaway before the poison takes effect.
	You may use \featref{potion-delay} when brewing a \mixdeliveryref{spike}.
}

\feat{Suspension Release}{potion-delay-release}{20}{
	\skillref[1]{brewing},
	\featref{potion-delay}
}{
	\mix{cauldron}{spike}{Egg yolk, \herb{mustard seeds}{3}}
	%Egg yolk is an emulsifier, to mix oil and water.
	%Mustard seeds have an immediate kick, and also contain emulsifiers.
	
	This mixture takes effect immediately, and counters the effects of \featref{potion-delay}, releasing the effects of all suspended mixtures in the drinker's body.
	All released mixtures then take effect after their normal time period, unless they were already going to take effect sooner.
	
	This mixture cannot itself be suspended with \featref{potion-delay}.
}

\feat{Suspension Suppression}{potion-delay-cancel}{15}{
	\skillref[1]{brewing},
	\featref{potion-delay}
}{
	\mix{cauldron}{spike}{Egg yolk, powdered charcoal}
	%Activated charcoal is used to absorb poisons.
	
	This mixture takes effect immediately, and nullifies the effects of every mixture in the drinker's body that has been suspended with \featref{potion-delay}.
	Only those that have not begun to take effect yet are cancelled.
	However, effects that are cancelled are cancelled completely, without any deleterious effects.
...
\feat{Universal Antidote}{antidote-all}{25}{
	...
	%Secondly, it is established by familiars that toads have a knowledge of brewing.
