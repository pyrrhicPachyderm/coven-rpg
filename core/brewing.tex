...
\feat{Universal Antidote}{antidote-all}{15}{
	...
	The application method of the other mixture is not changed by this process: a \mixdelivery{spike} remains a \mixdelivery{spike}, \mixdelivery{snuff} remains \mixdelivery{snuff}, and so on.
}
