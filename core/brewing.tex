...
\feat{Eyebright Drops}{sight-potion-light}{15}{
	None
}{
...
\feat{Eyedark Drops}{sight-potion-dark}{10}{
	None
}{
...
\feat{Projection Poison}{projection-poison}{20}{
	...
	You can brew a variant of \featref{projection-potion} that is delivered through the bloodstream, rather than nostrils.
...
\feat{Medium's Potion}{medium-potion}{10}{
	...
	This concoction grants finer control than use of the raw herb; the \featref{medium} may end the trance at any point by re-entering her body.
...
\feat{Regrowth Potion}{brewing-healing-regrow}{15}{
	\skillref[2]{brewing},
	\featref{brewing-healing}
}{
	\mix{cauldron}{drink}{\Herb{arbor vitae}{5}, a salamander's leg}
	%Salamanders can regrow limbs.
	%"Arbor vitae" is Latin for "tree of life".
	
	This potion stimulates growth and repair, even allowing the regeneration of missing body parts.
	However, it only works as long as the target rests.
	With one dose of the potion, the target heals twice as much damage during a {\dayofrest}.
	That is, they heal 4 points of {\damage}, plus any healed by their physician; the physician's healing is not doubled.
	The target needs to eat at least twice as much as normal, to fuel the regrowth.
	
	The target can also regrow missing body parts, albeit slowly.
	Fingers and ears will grow back in a day, while a limb or eye takes a week.
	This regeneration \emph{can} occur without complete rest, but takes at least twice as long.
	
	Taking more than one dose in a day causes overgrowth; ear-, nose-, or finger-like growths develop in inconvenient places, and the target becomes rather deformed.
