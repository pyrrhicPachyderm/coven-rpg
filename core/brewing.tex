...
\feat{Eyebright Drops}{sight-light-potion}{15}{
	...
	If taken alongside \featref{sight-dark-potion}, the user is blinded in both light and darkness.
}

\feat{Eyedark Drops}{sight-dark-potion}{10}{
	\mix{cauldron}{topical}{\Herb{carrot}{2}}
	
	The opposite of the \featref{sight-light-potion}, this potion grants excellent night vision, at the cost of an over-sensitivity to light.
	...
	Further doses produce no additional effect.
	If taken alongside \featref{sight-light-potion}, the user is blinded in both darkness and light.
}
