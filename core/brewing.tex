...
\feat{Brew of Claws}{weapon-potion}{10}{
	...
	Smeared on the hands, this mixture causes the fingers to calcify, and harden into wicked claws.
	They return to normal after about an hour.
	Roll 5 dice for unarmed {\damagetests} using the clawed hands.
	This benefit only works for humans, or other creatures with hands, if you run into any.
...
\feat{Hedgehog Hide}{resilience-potion-spines}{10}{
	...
	When a creature under the effect of such a spiny potion is hit by an unarmed \actionref{attack}, the attacker suffers a \dice{2} {\damagetest}.
}
