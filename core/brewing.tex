...
While some of the more noxious mixtures a witch can make come with adverse effects by design, these are not the only ways a potion can hurt.
...
\feat{Sleeping Solution}{sleep-spike}{10}{
	...
	They may stave off the effects with Tests, though it requires incredible fortitude to avoid sleep entirely.
