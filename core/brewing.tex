...
It requires a \testtype{ken}{brewing} Test to create an appropriate remedy for most ailments, with the TN of the Test determined by the rarity and severity of the ailment.
This normally requires access to a wide array of \materialrefplural{herb} and a boiling cauldron; the TN might be increased as normal by trying to make do with inadequate materials.
...
\feat{Garlic Solution}{garlic-spike}{15}{
	...
	The drinker must make a TN 15 \attref{might} Test or pass out immediately, unable to be roused for several minutes.
...
\feat{Kick From the Head}{projection-spike}{15}{
	...
	You can make a concotion with enough kick to knock the mind right out of the body.
	
	\mix{cauldron}{spike}{\Herb{garlic}{2}, \herb{morning glory}{3}}
	%Morning Glory is an Aztec entheogen.
	
	This concotion takes effect immediately, ejecting the drinker's mind from their body and into the {\mentalrealm}.
}
...
\feat{Medium's Potion}{medium-spike}{10}{
	...
	By brewing the herb used to enter a \featref{medium} trance into the right concotion, you can skip the tedious meditating.
	...
	This concotion takes effect immediately, ejecting the drinker's mind into the {\mentalrealm} and placing their body into a \featref{medium} trance.
