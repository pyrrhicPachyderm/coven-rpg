...
As with violations of a {\stipulation}, any condition that ends a {\contractpenalty} must be detected by one of the {\signatories} on the {\contract}, and all {\signatories} are made aware when a {\penalty} ends.
...
\feat[headology]{Consultation}{contracts-advice}{10}{
	\skillrefspeciality[1]{lore}{Contracts},
	\featref{contracts}
}{
	%TODO: Can collaborate with others, as scribe or as advisor.
}
