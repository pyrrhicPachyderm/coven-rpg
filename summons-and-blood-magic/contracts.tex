...
\feat[headology]{Blood Escrow}{contracts-penalty-taglock-blood}{5}{
	...
	You may add an additional {\contractpenalty} to {\contracts} you write.
	This functions exactly as \featref{contracts-taglock-simulation}, except that the \materialref{taglock} offered may be used as though it were specifically \materialref{blood} for any magic that requires such (e.g.\ \featref{symlink-blood}).
