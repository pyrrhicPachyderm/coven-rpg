...
It can also be used with {\penalties} that can have some beneficial effect, such as a {\contract} that provides \featref{contracts-penalty-location} between all members of a coven.
...
\section{Feats}
\setfeatdefault{discipline}{headology}{true}
\unsetfeatdefault{tags}

\feat{Signed in Blood}{contracts}{20}{
	\noprereq
}{
...
\feat{Multisign}{contracts-more-signatories}{10}{
...
\feat{Null and Void}{contracts-void}{10}{
	\skillrefspeciality[1]{lore}{Contracts},
	\featref{contracts}
}{
...
\feat{Dictate Terms}{contracts-collaborate}{5}{
	\skillrefspeciality[1]{lore}{Contracts},
	\featref{contracts}
}{
...
\feat{Taglock Escrow}{contracts-penalty-taglock}{15}{
	\featref{contracts}
}{
...
\feat{Blood Escrow}{contracts-penalty-taglock-blood}{5}{
...
\feat{Liar's Location}{contracts-penalty-location}{5}{
	\featref{contracts-penalty-taglock},
...
\feat{False Contract}{headology-contracts}{25}{
	\featref{contracts}
}{
	You can use traditional belief-based \discref{headology} to enforce false {\contracts}.
	If you can convince someone that they have {\signed} and broken a {\contract}, and are thus subject to a {\contractpenalty}, then you can subject them to the {\contractpenalty}.
	They must believe in the magic of the {\contract}, and understand what {\contractpenalty} they are supposedly under.
	
	As with genuine {\contracts}, you can initially only impose the {\liarscurse} this way, but you may also impose any {\contractpenalty} you have learned how to write into a {\contract}.
	If the {\contractpenalty} is ongoing it lasts only as long as they believe they are under it.
	Thus, it ends if they stop believing your trick, but also if they believe that the agreed-upon duration of the {\contractpenalty} has expired.
	
	This can work with an entirely false {\contract}, even one for which no physical document ever existed, as long as you can convince them that the document did exist and that they {\signed} it.
	However, this can also be used with a real {\contract}, be it {\void} or still in force.
	If they believe that they have violated the {\contract} and are under a {\contractpenalty}, then you can enforce the {\contractpenalty} this way.
	This has no impact on the genuine {\contract}, which might still apply the genuine {\contractpenalty} later.
}
