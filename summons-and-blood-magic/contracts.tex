...
If a {\stipulation} is violated, then the {\penalties} take effect upon the {\signatory} who violated them.
...
However, the GM may call for the {\signatories} to argue their cases, perhaps with associated Tests.
...
\feat[headology]{Null and Void}{contracts-void}{10}{
	...
	Now, when you create, or help to create, a {\contract}, you may add clauses that {\void} previous {\contracts}.
	Exactly which previous {\contracts} are {\voided} must be specified.
	Furthermore, every {\signatory} upon every {\contract} to be {\voided} must be a {\signatory} on the new {\contract}.
