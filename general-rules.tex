...
For every 3 points by which a character's damage exceeds their \attref{will}, they suffer a \negative{1} penalty to all Tests except Damage Tests.
For example, if a character with 1 \attref{will} is suffering 7 damage, their damage exceeds their \attref{will} by 6 and they suffer a \negative{2} penalty.
...
If a creature somehow has a Resilience of 0 or less, any Damage Test deals damage sufficient to drop its Shock Threshold to 0 and kills it.
