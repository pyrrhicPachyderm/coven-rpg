...
If a \seclink{Damage Test}{damage-tests} meets or exceeds the target's Shock Threshold, or critically succeeds, the target goes into {\shock}.
...
To calculate {\damage}, divide the result of the \seclink{Damage Test}{damage-tests} by the target's Resilience.
For example, if the result of the \seclink{Damage Test}{damage-tests} is 13 and the damaged creature has 3 Resilience, they suffer 4 {\damage}.
