...
\begin{simpletable}{Xll}
	\toprule
	Effect & Dice & Bonus\\
	\midrule
	Touching a hot cauldron & 1 & 0\\
	Crawling through brambles & 2 & 0\\
	Wave-tossed against a boulder & 3 & 0\\
	Hit by a falling brick & 4 & 0\\
	Falling on a sword & 5 & 0\\ %TODO: Evaluate and expand.
	Hit by a falling tree & 5 & 4\\
	\bottomrule
\end{simpletable}
...
A character in Shock falls unconscious.
If a character in Shock would go into Shock again due to another Damage Test, they die.

Additionally, at the start of every turn (roughly every ten seconds outside of combat), roll a special Test against the Shocked character.
This Test uses 3 dice with no bonus, and is not considered to be a Test made by any character.
...
Secondly, if a character's current damage ever equals or exceeds their original Shock Threshold (unmodified by damage), they die immediately.
This applies even if they are ignoring the effect of some of their damage, such as through painkillers.

Lastly, increasing damage can cause pain, having an adverse effect upon a character's actions.
For every 3 points by which a character's damage exceeds their Will, they suffer 1 pain.
For example, if a character with 1 Will is suffering 7 damage, their damage exceeds their Will by 6 and they suffer 2 pain.
However, if the character had 5 Will, their damage would exceed their Will by only 2 and they would not suffer any pain.

The amount of pain a character is suffering is subtracted from all Tests they make, except Damage Tests.
It is also subtracted from their Dodge Rating. %TODO: Check the name of this.
...
\begin{simpletable}{rX}
	...
	21 & Performing a simple 5 minute rite in one combat action.\\
	\bottomrule
\end{simpletable}
