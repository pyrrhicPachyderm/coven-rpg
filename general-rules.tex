...
Mistress Talbot dabbled in \chapnameref{necromancy} as a youth, and has one rank in the skill, so she rolls 4 dice.
...
Such Tests typically use \attref{attref} and the relevant skill for the discipline of magic, but not always.
